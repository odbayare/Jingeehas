...
const PATTERN_COPY = Object.freeze({
  ...
  low_movement: {
    ...
    effectOnWeightLoss: "Өдөр тутмын хөдөлгөөн бага байх нь зорилгод хүрэх хурдад нөлөөлж болно.",
  ...
  restrictive_rebound: {
    ...
    effectOnWeightLoss: "Төлөвлөснөөс өөр нэг сонголтыг бүтэлгүйтэл гэж үзвэл төлөвлөгөөг бүхэлд нь орхих магадлал нэмэгдэнэ.",
...
const SENTENCE_TEMPLATES = Object.freeze({
  ...
  overview_environmental: { requiredPatterns: ["environmental_cues"], text: "Өлсөөгүй үед орчны зарим дохио идэх хүсэлд тань нөлөөлдөг байна." },
  ...
  evidence_restrictive: { requiredPatterns: ["restrictive_rebound"], text: "Хэт хатуу дүрмийг удаан барихад хэцүү болж, төлөвлөснөөс өөр сонголт хийсний дараа төлөвлөгөөг бүхэлд нь орхих эрсдэл нэмэгдсэн байна." },
  ...
  experiment_meal_timing_priority: { requiredPatterns: ["irregular_meals_late_hunger", "hunger_satiety"], text: "Хоолны зайг эхэлж тогтворжуулснаар хэт өлсөлтийн нөлөөг багасгаж, өлсөх болон цадах дохиогоо анзаарах хүндрэл хэр өөрчлөгдөж байгааг илүү тод ажиглана." },
  experiment_meal_timing_stress: { requiredPatterns: ["irregular_meals_late_hunger", "hunger_satiety", "emotional_regulation"], text: "Стрессийн үеийн идэх хүсэл тусдаа хэвээр байгаа эсэхийг мөн ажиглана." },
...
const RECOMMENDATIONS = Object.freeze({
  ...
  fixed_wind_down: { action: "Унтахаас өмнө тайвшрах нэг тогтмол үйлдэл хийнэ.", reason: "Оройн ачааллыг бага зэрэг бууруулах нь маргааш ядарсан үед хамгийн ойр байгаа хоолыг яаран сонгох эрсдэлийг багасгана." },
...
const STRATEGY_COPY = Object.freeze({
  ...
  remove_one_strict_rule: { action: "Төлөвлөгөөг бүхэлд нь солихгүй; төлөвлөгөөг бүхэлд нь орхих эрсдэлийг нэмэгдүүлдэг нэг хатуу дүрмийг уян болгоно.", reason: "Нэг дүрмийг өөрчлөх нь төлөвлөснөөс өөр сонголт хийсний дараа бүх төлөвлөгөөг орхих эрсдэлийг багасгана." },
...
const PROTECTIVE_COPY = Object.freeze({
  ...
  regular_meal_rhythm: "Хоол хоорондын зай тань тогтвортой байгаа нь хоолны цаг тогтмол бус байх асуудал гол саад биш гэдгийг харуулна.",
