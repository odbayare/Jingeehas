...
const { BROWSER_EVENTS, UUID, clientContext, flagsFromEvent, browserOriginAllowed, hashAnonymous, recordEvent } = require("./_lib/analytics.js");
...
exports.handler = handler("POST", async (event, body) => {
  ...
  await recordEvent(database, body.eventName, context, { assessmentId }, { eventId: body.eventId, rateKeyHash, ...flagsFromEvent(event) });
