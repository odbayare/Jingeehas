...
const personas = [
  ...
  },
  {
    ...
    expectedMode: "deep",
    expectedText: ["Удаан юм идээгүй өдөр орой гэнэт өлсөж байгаагаа анзаардаг.", "Дараа дахиад өлсөх"],
  ...
  },
  {
    ...
    expectedMode: "deep",
    expectedText: ["сарын тэмдэг ирэхээс өмнөх", "онош биш", "хэт хатуу дүрэм"],
