...
function scoreResult(persona, result) {
  ...
  const hasPaidValue = result.mode === "deep"
    ? containsAny(text, ["Энэ зан үйл ямар үүрэгтэй байж болох вэ?", "Асуудал яг юу биш вэ?", "Давтагддаг тойрог", "2. Яагаад давтагдаад байна вэ?", "3. Таны өдөр тутмын тойрог"])
