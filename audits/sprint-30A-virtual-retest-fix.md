...
- Internal feedback survey price wording used `29,000₮ төлж`, which read less natural than a clear currency form.
...
- Updated feedback survey price wording to `Энэ тайланг 29,000₮-өөр авахад үнэ цэнтэй санагдах уу?`.
...
- Feedback survey must contain `29,000₮-өөр`.
- Feedback survey must not contain `29,000 төлж` or `29,000₮ төлж`.
