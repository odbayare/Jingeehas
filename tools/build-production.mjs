...
execFileSync(process.execPath, ["tools/build-pilot-v2-instrument.mjs"], { cwd: root, stdio: "inherit" });
...
fs.cpSync(path.join(root, "pilot-v2"), path.join(output, "pilot-v2"), { recursive: true });
