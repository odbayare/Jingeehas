...
const secretNames = ["JINGEEHAS_DATABASE_API_KEY", "QPAY_CLIENT_SECRET", "RECOVERY_ENCRYPTION_KEY", "RECOVERY_HASH_PEPPER", "RECOVERY_DELIVERY_API_KEY", "META_CAPI_ACCESS_TOKEN"];
