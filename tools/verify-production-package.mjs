...
for (const forbidden of ["mockBackend.js", "MockBackend", "internalTest", "localStorage", "oneTimePaid", "feedback-export", "META_CAPI_ACCESS_TOKEN"]) if (publicText.includes(forbidden)) failures.push(`forbidden public signal: ${forbidden}`);
