...
const NATURAL_COPY = Object.freeze([
  ...
  ["Өдөр бүр ижил биш тул яг аль цагт хүндрэл үүсдгийг ажиглах хэрэгтэй.", "Энэ байдал өдөр бүр ижил давтагддаггүй."],
  ...
  ["Ядарсан үед хоол бэлтгэх, сонголтоо урьдчилан бодох тэнхээ багасч, тогтвортой төлөвлөгөө барихад саад болдог.", "Ядарсан үед хоол бэлтгэх, урьдчилан сонгох нь хэцүүдэж, төлөвлөгөөгөө тогтвортой үргэлжлүүлэхэд саад болдог."],
...
const CANONICAL_V8_COPY = Object.freeze([
  ["Ийм үед идэх хэмжээгээ тайван тохируулахад хэцүү болж болно.", "Ийм үед идэх хэмжээгээ тайван тохируулах хэцүүддэг."],
  ["Хоолны зай уртсахад өлсөлт хүчтэй болж, цадсанаа анзаарах эсвэл хэмжээгээ тохируулахад илүү хэцүү болж болно.", "Хоолны зай уртсахад өлсөлт хүчтэй болж, цадсанаа анзаарах эсвэл хэмжээгээ тохируулах илүү хэцүүддэг."],
  ["Нойр дутуу өдөр ядаргаа нэмэгдэж, өдөр тутмын төлөвлөгөөний хамгийн бага бэлтгэл шаардсан хувилбарыг ч хийхэд хүнд болж болно.", "Нойр дутуу өдөр ядаргаа нэмэгдэж, өдөр тутмын төлөвлөгөөний хамгийн бага бэлтгэл шаардсан хувилбарыг ч хийхэд хүндэрдэг."],
  ["Жин хасах төлөвлөгөө өдөр бүр яг ижил хэрэгжихгүй байж болно.", "Жин хасах төлөвлөгөө өдөр бүр яг ижил хэрэгждэггүй."],
