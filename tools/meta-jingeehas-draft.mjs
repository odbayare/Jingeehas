...
import priceCatalog from "../product-config.js";

const { PRODUCT: CURRENT_PRODUCT } = priceCatalog;
const PRODUCT_CODE = CURRENT_PRODUCT.code;
const PRICE_MNT = CURRENT_PRODUCT.amount;
