...
function run() {
  ...
  assert(oneTimeText.includes("Энэ хэсгийг 7 хоногоор илүү тодруулж болно"));
  ...
  assert(mode2Text.includes("Таны давтамж харагдаж байна"));
  assert(mode2Text.includes("эхний туршилт илүү зөөлөн, аюулгүй байна"));
