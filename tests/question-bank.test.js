...
assert(landing.includes("Тест үнэгүй · Хувийн тайлан 39,000₮"));
...
assert(!landing.includes("Үнэ: 39,000₮"));
const landingHero = /<section class="hero"[^>]*>[\s\S]*?<\/section>/.exec(landing)?.[0] || "";
assert(landingHero);
assert(landingHero.includes("39,000₮"));
...
assert(completion.includes("39,000₮"));
...
assert(paymentPage.includes("Үнэ: 39,000₮"));
assert(paymentPage.includes("39,000₮-ийн QPay нэхэмжлэл үүсгэх"));
