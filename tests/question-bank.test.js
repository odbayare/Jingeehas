...
assert(landing.includes("Буруу нь таны хүсэл зориг биш байж магадгүй."));
assert(landing.includes("40 хүртэл асуулт"));
...
assert(landing.includes("Өөрийгөө ойлгох нь өөрчлөлтийн эхний алхам"));
