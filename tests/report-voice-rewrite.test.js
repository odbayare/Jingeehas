...
assert(user03.includes("Шинэ төлөвлөгөө хэт чанга эхэлнэ"));
assert(user03.includes("Өнөөдөр өнгөрлөө"));
assert(user03.includes("дараагийн хоолноос хэвийн үргэлжлүүлэх"));
assert(!user03.includes("дараагийн хоолноос хэвийн үргэлжлүүлэх замгүй болох үүрэг"));

const user05 = report("user-05");
assert(user05.includes("өөрийн хэрэгцээ хамгийн сүүлд"));
...
assert(user06.includes("хоол харагдах"));
assert(user06.includes("Орчны дохио") || user06.includes("орчны дохио"));
