...
const forbiddenPublicTerms = ["шилжилтийн саад", "үр дүнгээ хадгалах шилжилт", "залгамж хувилбар", "Зангуу", "зангуун", "Доод хувилбар", "доод хувилбар", "Зардлын зааг", "Биеийн дурдсан нөхцөл", "биеийн дурдсан нөхцөл", "аюулгүй хувилбар"];
...
for (const fixture of fixtures) {
  ...
  assert(Array.isArray(report.overallPicture) && report.overallPicture.length <= 3, `${fixture.name}: section 1 must have at most three paragraphs`);
...
assert.equal(transition.influencingPatterns.find(item => item.id === "previous_attempt_sustainability").evidenceSummary, "Өмнөх аргаас авсан үр дүнг өдөр тутам хадгалах орлуулах төлөвлөгөө дутсан нь хариултуудаас харагдаж байна.");
