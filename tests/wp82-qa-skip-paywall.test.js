...
assert(qaReport.includes("1. Энэ тайлан юунд тулгуурласан бэ?"), "QA direct report must render WP81 expanded report");
assert(qaReport.includes("8. 7–14 хоногийн туршилт"), "QA direct report must keep expanded experiment section");
