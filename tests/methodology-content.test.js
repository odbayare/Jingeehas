...
for (const exactCopy of ["Таны авах тайлан", "Таны тайлан ямар байх вэ?", reportPreviewLead, ...reportPreviewLabels, ...reportPreviewBodies, "Үнэгүй тест · Хувийн бүрэн тайлан", "19,900₮", "Энэ тайлан нь эмнэлгийн болон сэтгэлзүйн онош биш."]) assert(landing.includes(exactCopy), exactCopy);
