...
function run() {
  ...
  assert(choice.includes("Нээлтийн урамшуулалт үнэ 9,900₮"), "One-Time promo price should be visible");
  assert(choice.includes("9,900₮ төлөөд тайлангаа нээх"), "One-Time card should use paid report CTA");
  ...
  assert(unpaidOneTime.includes("Нээлтийн урамшуулалт үнэ 9,900₮"));
  ...
  assert(!unpaidOneTime.includes("Энэ зан үйл ямар үүрэгтэй байж болох вэ?"));
  ...
  assert(paidOneTime.includes("Энэ зан үйл ямар үүрэгтэй байж болох вэ?"));
  assert(paidOneTime.includes("14 хоногийн эхний туршилт"));
