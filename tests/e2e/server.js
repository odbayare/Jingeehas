...
const endpoints = {
  ...
  "weight-assessment-create": async (_body, response) => { assessmentStatus = "payment_pending"; json(response, 201, { assessmentId: "wa-e2e", status: assessmentStatus, commercialFlowVersion: "prepaid_v2", questionnaireVersion: questions.QUESTIONNAIRE_VERSION }); },
