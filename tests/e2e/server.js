...
const endpoints = {
  ...
  "admin-analytics-daily": async (_body, response) => {
    ...
    json(response, 200, {
      ...
      cleanControl: { cohort: { utmContent: "price_aligned_39000_control_v1", lockedAttribution: true }, visitors: 25,
        assessmentsStarted: 8, assessmentsCompleted: 8, safetyBypass: 7, commercialEligible: 1, paywallConfirmed: 1,
        eligiblePaywallConfirmed: 1, paywallCta: 1, invoicesCreated: 1, providerConfirmedPaid: 0, merchantSettledPaid: null,
        revenueMnt: 0, unclassifiedCompletions: 0, explainedDeliveryExceptions: 0,
        invariants: { completionClassified: true, eligibleDeliveryReconciled: true },
        rates: { lpvToStart: { numerator: 6, denominator: 25, rate: 0.24 }, startToCompletion: { numerator: 8, denominator: 8, rate: 1 },
          completionToSafetyBypass: { numerator: 7, denominator: 8, rate: 0.875 }, completionToCommercialEligible: { numerator: 1, denominator: 8, rate: 0.125 },
          eligibleToPaywall: { numerator: 1, denominator: 1, rate: 1 }, paywallToCta: { numerator: 1, denominator: 1, rate: 1 },
          ctaToInvoice: { numerator: 1, denominator: 1, rate: 1 }, invoiceToProviderConfirmedPaid: { numerator: 0, denominator: 1, rate: 0 },
      ...
      campaignAttribution: { rows: [{ utmSource: "meta", utmMedium: "paid_social", utmCampaign: "jingeehas_traffic_lpv_reel_v1",
        ...
        reportsOpened: 2, revenueMnt: 19800 },
      { utmSource: "fb", utmMedium: "paid", utmCampaign: "52504900416602", utmContent: "52508731514802", utmTerm: "52504900416802",
        unattributed: false, visitors: 200, assessmentsStarted: 55, assessmentsCompleted: 41, paywallViews: 19, fullReportCtaClicks: 7,
        invoicesCreated: 7, paymentsConfirmed: 5, reportsOpened: 5, revenueMnt: 49500 },
      { utmSource: "ig", utmMedium: "paid", utmCampaign: "52504900416602", utmContent: "52508731514802", utmTerm: "52504900416802",
        unattributed: false, visitors: 19, assessmentsStarted: 3, assessmentsCompleted: 2, paywallViews: 1, fullReportCtaClicks: 0,
        invoicesCreated: 0, paymentsConfirmed: 0, reportsOpened: 0, revenueMnt: 0 },
      { utmSource: "meta", utmMedium: "paid_social", utmCampaign: "jingeehas_sales_purchase_image_v1", utmContent: "price_aligned_39000_control_v1", utmTerm: "broad_25plus",
        unattributed: false, visitors: 25, assessmentsStarted: 8, assessmentsCompleted: 8, paywallViews: 1, fullReportCtaClicks: 1,
        invoicesCreated: 1, paymentsConfirmed: 0, reportsOpened: 0, revenueMnt: 0 },
