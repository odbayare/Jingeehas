...
function assertLaunchSafeOutput(html, label) {
...
withLocalStorageMutationSpy(() => {
  ...
  assertLaunchSafeOutput(paidHtml, "paid output");
  ...
  assert(!paid.includes("Бүрэн тайлан нээх 29,000₮"), "paid output must not show locked payment state");
