...
function run() {
  ...
  assertIncludesAll(helperText, [
    "тухайн хүнсийг идсэний дараах таны өөрийн анзаарсан мэдрэмж",
    "өөрийн анзаарсан мэдрэмж, шингэц, өлсөлт, цатгалан байдал"
  ]);
  assert(!helperText.includes("цусны бүлгийн"));
  ...
  assertExcludesAll(redMeat, ["улаан махыг бүр мөсөн хас", "цусны бүлэгт тохирох", "цусны бүлгээр", "цусны бүлгийн"]);
  ...
  assertIncludesAll(eliminationRisk, [
    "Хэт хатуу хориг ба дараа нь нөхөж идэх эрсдэл",
