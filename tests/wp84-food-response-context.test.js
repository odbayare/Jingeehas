...
function run() {
  ...
  assertIncludesAll(redMeat, [
    ...
    "порцыг багасгах",
    "эрт идэх",
    "тос багатай/шарсан биш",
    "ногоо эсвэл шөлтэй хослуулах",
    "Эхний 7–14 хоногийн туршилт"
  ]);
  ...
  assertIncludesAll(flourSweet, [
    "Гурил/чихэрлэг зүйл ба өлсөлт хурдан эргэх",
    "порц",
    "уураг/ногоотой хослуулах",
    "Бүх гурилыг хорих биш",
  ...
  assertIncludesAll(dairy, [
    "Сүү, сүүн бүтээгдэхүүний биеийн мэдрэмж",
    "бага порц",
    "исгэсэн хэлбэр",
  ...
  assertIncludesAll(eliminationRisk, [
    "Хэт олон хүнс бүрэн хасах эрсдэл",
    "Олон хүнсийг нэг дор бүрэн хасах",
    "Нэг хүнс эсвэл нэг нөхцөл",
    "нэг хувьсагч",
    "Олон хүнсийг зэрэг хорихгүй"
  ]);
