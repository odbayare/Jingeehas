...
function run() {
  ...
  assertIncludesAll(sedentary, [
    ...
    "Суугаа ажил ба бага NEAT хөдөлгөөн",
    "5–10 минутын алхах/зогсох завсарлага",
  ...
  assertIncludesAll(workFromHome, [
    "Гэрээс ажиллах ба хоолны дохио",
    "харагдах зуушны boundary",
    "transition walk"
  ]);
