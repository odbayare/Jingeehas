...
function run() {
  ...
  assertIncludesAll(sedentary, [
    ...
    "Өдөржин суух, бага хөдөлгөөн ба оройн стрессийн идэлт",
    "суугаа",
  ...
  assertIncludesAll(heavyWork, [
    "Биеийн ачаалалтай ажил, хоол алгасалт ба оройн нөхөх идэлт",
  ...
  assertIncludesAll(workFromHome, [
    "Гэрээс ажиллах үед хоол ойр харагдах давталт",
    "нэг гол зууш/ундааг нэг алхам холдуулаад",
    "ажлын төгсгөлд 5–10 минут завсарлага"
  ]);
  ...
  assertIncludesAll(shiftWork, [
    "Ээлжийн ажлын хэмнэл ба хоолны цаг зөрөх үе",
