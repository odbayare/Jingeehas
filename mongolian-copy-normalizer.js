(function initMongolianCopyNormalizer(root, factory) {
  ...
  const POLITE_ENDINGS = [
    [/(^|\s)тав\.(?=\s|$)/g, "$1тавиарай."],
    [/(^|\s)сонго\.(?=\s|$)/g, "$1сонгоорой."],
    [/(^|\s)тэмдэглэ\.(?=\s|$)/g, "$1тэмдэглээрэй."],
    [/(^|\s)бэлд\.(?=\s|$)/g, "$1бэлдээрэй."],
    [/(^|\s)ялга\.(?=\s|$)/g, "$1ялгаарай."],
    [/(^|\s)буц\.(?=\s|$)/g, "$1буцаарай."],
    [/(^|\s)ашигла\.(?=\s|$)/g, "$1ашиглаарай."],
    [/(^|\s)анзаар\.(?=\s|$)/g, "$1анзаараарай."],
    [/(^|\s)турш\.(?=\s|$)/g, "$1туршаарай."],
    [/(^|\s)хамгаал\.(?=\s|$)/g, "$1хамгаалаарай."],
    [/(^|\s)холдуул\.(?=\s|$)/g, "$1холдуулаарай."],
    [/(^|\s)тогтоо\.(?=\s|$)/g, "$1тогтоогоорой."],
    [/(^|\s)үргэлжлүүл\.(?=\s|$)/g, "$1үргэлжлүүлээрэй."],
    [/(^|\s)холбогд\.(?=\s|$)/g, "$1холбогдоорой."]
  ];
  ...
  function normalizeTextNode(node) {
    ...
    const next = `${leading}${normalizeMongolianCopyText(current)}${trailing}`;
