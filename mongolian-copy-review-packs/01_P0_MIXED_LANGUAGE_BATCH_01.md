...
- Priority: P0
- Review group: mixed
- Structural signal: METHODOLOGY_NAME
- Surface: LANDING
- Role: PUBLIC_USER
- Scenario: landing
...
- Surface: ADVISOR_PORTAL
- Role: ADVISOR
- Scenario: advisor-dashboard-populated
- Render source: renderCoachDashboard with mock paid client fixture
- Extraction type: FULL_SURFACE
- Occurrence count: 1
- Duplicate group: None
- Source file: app.js
...
- Source function/object: UNRESOLVED
- Source mapping: UNRESOLVED
- Render proof: renderCoachDashboard with mock paid client fixture via advisor-dashboard-populated [FULL_SURFACE]
- Cross-group references: None
