...
`Жингээ Хас — хувийн бүрэн тайлан` нь үнэгүй тест болон эхний үр дүнгийн дараа хүсвэл нээх нэг удаагийн төлбөртэй бүтээгдэхүүн. Одоогийн authoritative үнэ `19,900₮`; `9,900₮` болон `39,000₮` нь зөвхөн хуучин төлбөрийг баталгаажуулахад хадгалагдана.

## Хамгаалагдсан бүтээгдэхүүн

- Бүтээгдэхүүний код: `WEIGHT_TEST_ONE_TIME`
- Одоогийн шинэ нэхэмжлэлийн дүн: `19900`
- Одоогийн харагдах үнэ: `19,900₮`
- Үнийн хувилбар: `p19900_v1`
- Хуучин төлбөрийн дүн: `9900`, `39000` — verify/entitlement compatibility only
...
Production deployment нь тусдаа хамгаалалттай release workflow-оор хийгдэнэ. Автомат тест бодит нэхэмжлэл эсвэл төлбөр үүсгэхгүй.
