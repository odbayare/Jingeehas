...
2. Restore the preceding `jingeehas.execute_request(jsonb)` definition from `20260720085252_repair_daily_funnel_source_of_truth.sql` plus the report-snapshot branches already present in production.
