...
function renderLanding() {
  ...
  return `<div class="page landing-page">${navigation()}<main>
    ...
    <section class="mirror-section" aria-labelledby="mirror-title"><p class="eyebrow">Танд танил байж болох мөчлөгүүд</p><h2 id="mirror-title">Та эдгээрийг өөр дээрээ анзаарч байсан уу?</h2><div class="mirror-grid">
      ...
      <article><h3>Хэцүү өдрийн орой</h3><p>Хэцүү өдрийн орой гар аяндаа хөргөгч рүү явдаг. Өлсөөгүй байгаагаа мэднэ. Гэхдээ зогсдоггүй.</p></article>
      <article><h3>Оройдоо эвддэг</h3><p>Өдөржин барьчихаад оройдоо эвддэг. Дараа нь өөртөө уурлана. Маргааш орой нь дахиад л.</p></article>
    ...
    <section class="cta-banner" aria-label="Тест эхлүүлэх"><p>Эдгээрийн аль нэг нь танил санагдсан уу?</p><p>${count} асуултад хариулаад өөрт тань давтагддаг зүйлсийн тайлангаа авна.</p><a class="button primary-cta" href="/assessment/start" data-route data-primary-cta>${primary}</a></section>
    ...
    <section id="sample-report" class="sample-report" aria-labelledby="sample-title"><p class="eyebrow">Нэргүй жишээ</p><h2 id="sample-title">Таны тайлан ийм бүтэцтэй байна</h2><p class="muted">Доорх нь нэргүй жишээ. Энэ нь таны үр дүн биш; тайлангийн нарийвчлал, бүтэц, хэлбэрийг урьдчилж харуулж байна.</p><div class="sample-report-card"><p class="sample-kicker">ГОЛ ЗУРШИЛ — Стрессээ хоолоор дардаг</p><p>Таны хариултаас харахад идэх нь өлсгөлөнгөөс илүү ачаалал бууруулах үүрэг гүйцэтгэдэг байж болохоор байна. Хамгийн хүнд өдрүүдийн орой эрсдэл нэмэгддэг зураглал харагджээ.</p><p class="sample-kicker">АМЬДРАЛ ДЭЭР</p><p>Өдөржин чангалсан хэрээрээ орой нь суларна. Долоо хоног “зөв” явбал амралтын өдөр нөхөлт ирж болно. Энэ тэнцвэргүй хэлхээ таны гол саад байж болохоос, тэвчээрийн дутагдал гэж шууд дүгнэх үндэс биш.</p><p class="sample-kicker">ЭХНИЙ АЛХАМ</p><p>Эхний долоо хоногт ямар нэг зүйлийг шууд хасах гэж яарахгүйгээр нэг л зүйл тэмдэглээд үзээрэй: хэзээ, ямар мэдрэмжтэй үедээ идэв. Ингээд харахад зураг өөрөө гарч ирдэг.</p></div><p class="section-close">Таны хариултад харагдсан давтагддаг зүйл, өдөөгч, мөчлөгийг ойлгоход зориулсан хувийн эргэцүүлэл өгнө.</p></section>
