...
function refinementBullets(primary, secondary = []) {
  ...
  const copy = {
    ...
    gymRestriction: [
      ...
      "Өлсөхийг сахилга бат гэж бодсон өдөр rebound илүү гарч байна уу?"
    ],
    bodyTrustMedical: [
...
const REPORT_VOICE_LIBRARY = {
  ...
  shiftWork: {
    ...
    notProblem: "Гол нь зөвхөн нойр муудсандаа биш. Шөнийн ээлжийн дараа бие, толгой хоёр зэрэг суларсан үед хоол амрах, тэнхээ авах, өөрийгөө жаахан шагнах хамгийн ойрын арга болж байна.",
  ...
  socialWeekend: {
    ...
    notProblem: "Гол нь зөвхөн архи эсвэл хоол биш. Хүмүүс идэж, ууж байхад татгалзах эвгүй санагддаг, belonging буюу хамт байх мэдрэмжээ алдахгүй гэсэн хэрэгцээ оролцож байна.",
  ...
  perimenopauseContext: {
    ...
    notProblem: "Энэ нь онош биш. Мөчлөг тогтмол бус үед өдрөөр нь хатуу тайлбарлах хэрэггүй. Гол нь бие өөрчлөгдөх тодорхойгүй мэдрэмж хяналт хайх, өөрийгөө буруутгах, орой тайвшрах зүйл хайхтай холбогдож байна.",
  ...
  gymRestriction: {
    opening: [
      ...
      "Тэр үед хэтрүүлсэн мэт санагдах идэлт үнэндээ өдөржин барьсан хязгаарлалтын rebound байж болно."
    ],
    needs: [
    ...
    notProblem: "Асуудал сахилга бат дутагдсандаа биш. Өлсөхийг зөв явж байгаагийн баталгаа гэж үзэхэд бие орой хамгаалах хариу өгч, rebound тойрог үүсэж байна.",
    ...
    experiment: [
      ...
      ["11-14 дахь өдөр", "тулгуур хоолтой өдөр rebound идэлт багассан эсэхийг анзаар."],
  ...
  const summaries = {
    ...
    gymRestriction: {
      ...
      meaningBullets: [
        ...
        "Энэ нь сахилга бат дутагдсандаа биш, хэт чанга эхлэлийн rebound байж магадгүй."
      ],
      firstStep: "Дасгалтай өдөр оройн өлсөлтөөс өмнө уураг/нүүрс ус багтсан нэг тулгуур хоол бэлд.",
...
function foodFunctionIntro(voiceKey) {
  return {
    ...
    shiftWork: "Ээлжийн дараа хоол амрах, тэнхээ авах, өөрийгөө жаахан шагнах хамгийн ойрын арга болж байна.",
