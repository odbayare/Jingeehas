...
function ordinaryReportOpeningTitle(primaryKey, tags = []) {
  ...
  if (primaryKey === "hungerSafety" || tags.includes("hunger_safety")) {
    return "Удаан юм идээгүй өдөр орой гэнэт өлсөж байгаагаа анзаардаг.";
  }
...
const REPORT_VOICE_LIBRARY = {
  ...
  hungerSafety: {
    ...
    notProblem: "Асуудал орой идсэндээ биш. Удаан юм идээгүй өдөр орой гэнэт өлсөж байгаагаа анзаардаг.",
  ...
  rewardDeficit: {
    ...
    needs: ["Өөртөө өгөх жижиг таатай мөч", "Өдөржин хойш тавигдсан өөрийгөө санах", "Өөрийн цаг хэрэгтэй санагдах"],
    cycle: [
...
function foodFunctionIntro(voiceKey) {
  return {
    ...
    rewardDeficit: "Өдөржин өөрийгөө хойш тавьсан өдөр орой амттай зүйл өөртөө өгч байгаа жижигхээн шагнал шиг л санагддаг.",
...
function reportEvidenceNote(voiceKey) {
  return {
    ...
    hungerSafety: "Удаан юм идээгүй өдөр орой гэнэт өлсөж байгаагаа анзаардаг.",
