...
function renderLanding() {
  ...
  const micro = `${count} хүртэл асуулт · ${VERIFIED_LANDING_DURATION} · Дэлгэрэнгүй хувийн тайлан`;
  ...
  return `<div class="page landing-page">${navigation()}<main>
    <section class="hero landing-hero" aria-labelledby="page-title"><div class="hero-copy">
      <p class="eyebrow">Өөрийгөө буруутгалгүйгээр ойлгож эхэлье</p>
      <h1 id="page-title" tabindex="-1">Та жингээ хасах гэж олон удаа оролдсон ч үр дүн гарахгүй байна уу?</h1>
      <p class="hero-lead approved-copy">Буруу нь таны хүсэл зориг биш байж магадгүй. Энэ үнэлгээ жин хасахад тань саад болж буй сэтгэлзүйн хэв маяг, далд зуршлыг өөрийгөө буруутгалгүйгээр олж харахад тусална.</p>
    ...
    </div><div class="hero-visual" aria-hidden="true"><div class="hero-steps"><p><strong>01</strong> Асуултад хариулах</p><p><strong>02</strong> Давтагддаг хэв маягаа олно</p><p><strong>03</strong> Дэлгэрэнгүй тайлангаа авна</p><small>Онош биш. Өөрийгөө танин мэдэх үнэлгээ.</small></div></div></section>
    ...
    <section class="mirror-section" aria-labelledby="mirror-title"><p class="eyebrow">Танд танил байж болох мөчлөгүүд</p><h2 id="mirror-title">Та эдгээрийг өөр дээрээ анзаарч байсан уу?</h2><div class="mirror-grid">
      <article><h3>“Даваа гарагаас” гэдэг мөчлөг</h3><p>“Энэ удаад л жинхэнээсээ эхэлнэ” гэж хэдэн ч удаа хэлснээ санахгүй байх. Эхний хэдэн өдөр сайн явдаг ч нэг л мэдэхэд хуучин хэвэндээ орчихсон байдаг.</p></article>
      <article><h3>Стресстэй үед хоол руу хандах</h3><p>Ажил дээр дарамттай өдөр, хүнтэй муудалцсан орой хамгийн түрүүнд идэх юм хайж байгаагаа хожим нь л анзаардаг. Өлссөндөө биш гэдгээ дотроо мэддэг.</p></article>
      <article><h3>Орой болохоор хяналт алдах</h3><p>Өдөржин зөв хооллочихоод орой гэртээ ирээд бүгдийг нь эвдчихдэг. Дараа нь “яахаараа би ийм байдаг юм бэ” гэж өөртөө уурладаг.</p></article>
      <article><h3>Хүний өмнө өөр, ганцаараа өөр</h3><p>Бусадтай хамт байхдаа бага идээд, ганцаараа үлдэхээрээ нөхөж иддэг. Үүнийгээ хэнд ч хэлдэггүй.</p></article>
      <article><h3>Хассан жин буцаад ирдэг</h3><p>Диет барьж байж хассан килограммууд хэдхэн сарын дотор буцаад ирдэг, заримдаа илүүтэйгээ. “Би л тэвчээргүй юм байна” гэж дүгнэчихдэг.</p></article>
      <article><h3>Толинд харахаас зайлсхийх</h3><p>Зураг дээр гарахаас татгалзах, хэмжээгээ мэдэхээс айх, толины хажуугаар хурдан өнгөрөх — жин биш, мэдрэмж нь илүү дарамт болчихсон байдаг.</p></article>
    </div><p class="section-close">Таны хариулт эдгээрийн аль нь илүү давтагдаж байгааг тайлангаар нэгтгэн харуулна.</p></section>
    <section class="cta-banner" aria-label="Тест эхлүүлэх"><p>Эдгээрийн аль нэг нь танил санагдсан уу?</p><p>${count} асуултад хариулаад өөрийн давтагддаг хэв маягийн тайлангаа авна.</p><a class="button primary-cta" href="/assessment/start" data-route data-primary-cta>${primary}</a></section>
    <section class="value-section" aria-labelledby="show-title"><p class="eyebrow">Таны хариултаас</p><h2 id="show-title">Энэ үнэлгээ юуг харуулах вэ?</h2><div class="value-grid"><article><h3>01 — Давтагддаг хэв маяг</h3><p>Таны хооллолт, хяналт алдалт ямар нөхцөлд, ямар дарааллаар давтагддагийг таньж харахад тусална.</p></article><article><h3>02 — Далд өдөөгч</h3><p>Өлсгөлөн биш харин сэтгэл хөдлөл, орчин, зуршил хэзээ таныг идэхэд хүргэдгийг ялгаж өгнө.</p></article><article><h3>03 — Өмнөх оролдлогууд яагаад тогтоогүй байж болох вэ</h3><p>Диет, дасгал, бэлдмэл — аль нь яагаад түр зуурын үр дүн өгөөд замхарсныг таны хэв маягтай холбож тайлбарлана.</p></article><article><h3>04 — Дэлгэрэнгүй тайлан</h3><p>Таны хариултад тулгуурласан, зөвхөн танд зориулсан хувийн тайлан гаргана.</p></article></div></section>
    <section class="value-section" aria-labelledby="learn-title"><p class="eyebrow">Төлбөрөөс өмнө тодорхой мэдэх зүйл</p><h2 id="learn-title">Үнэлгээ хийлгэснээр юу мэдэж авах вэ?</h2><div class="value-grid"><article><h3>Хувийн хэв маягийн зураглал</h3><p>Таны хариултад хамгийн тогтвортой давтагдсан хандлага, өдөөгчийг эрэмбэлж харуулна.</p></article><article><h3>Амьдрал дээр хэрхэн илэрдэг тайлбар</h3><p>Ажлын дарамт, гэр орны орчин, нойр, амралтын өдрүүд таны хооллолтод хэрхэн нөлөөлдгийг өдөр тутмын жишээтэй холбоно.</p></article><article><h3>Зуршлын үүрэг ба өнөөгийн өртөг</h3><p>Нэг үед таныг тайвруулж байсан зуршил одоо хаана саад болж байгааг ялгаж тайлбарлана.</p></article><article><h3>Одоо анзаарах 3 жижиг алхам</h3><p>Өөрийгөө хүчээр өөрчлөх том амлалт биш, дараагийн долоо хоногт туршиж болох бодит ажиглалт авна.</p></article></div></section>
    <section id="sample-report" class="sample-report" aria-labelledby="sample-title"><p class="eyebrow">Нэргүй жишээ</p><h2 id="sample-title">Таны тайлан ийм бүтэцтэй байна</h2><p class="muted">Доорх нь нэргүй жишээ. Энэ нь таны үр дүн биш; тайлангийн нарийвчлал, бүтэц, хэлбэрийг урьдчилж харуулж байна.</p><div class="sample-report-card"><p class="sample-kicker">ГОЛ ХЭВ МАЯГ</p><h3>Стрессээ хоолоор намжаах</h3><p>Таны хувьд идэх нь өлсгөлөнгийн хариу гэхээсээ илүү ачааллыг буулгах арга болсон байж болно. Хамгийн хүнд өдрүүдийн орой хяналт алдах магадлал өндөр байж болно.</p><p class="sample-kicker">АМЬДРАЛ ДЭЭР</p><h3>Орой долоо хоногийн ачааллыг нөхөх</h3><p>Өдөржин “зөв” байх гэж чангалсан хэмжээгээр орой нь сулрал ирдэг. Энэ нь тэвчээрийн асуудал биш, хэт хатуу дэглэмийн урвуу үр дагавар байж болно.</p><p class="sample-kicker">ЭХНИЙ АЛХАМ</p><h3>Хориглохын оронд ажиглах</h3><p>Дараагийн долоо хоногт юу ч хасалгүйгээр зөвхөн “хэзээ, ямар мэдрэмжтэй үедээ идэв” гэдгээ тэмдэглэж үзээрэй. Хэв маягаа харах нь өөрчлөлтийн эхний бодит алхам.</p></div><p class="section-close">Таны хариултад харагдсан хэв маяг, өдөөгч, давтагддаг мөчлөгийг ойлгоход зориулсан хувийн эргэцүүлэл өгнө.</p></section>
    ...
    <section class="methodology-summary compact-methodology" aria-labelledby="methodology-title"><p class="eyebrow">Үндсэн ойлголт</p><h2 id="methodology-title">Яагаад хоол, дасгал дангаараа хангалтгүй байдаг вэ?</h2><p>Жин бол зөвхөн илчлэгийн тооцоо биш. Стресс, нойр, сэтгэл хөдлөл, олон жилийн зуршил хүний идэх зан үйлийг хоолны дэглэмээс хамаагүй хүчтэй удирддаг. Тийм учраас “юу идэхээ” мэддэг ч “яагаад ингэж иддэгээ” мэддэггүй хүнд ямар ч дэглэм удаан тогтдоггүй байж болно.</p><p class="methodology-principle">Илүүдэл жин нь тэвчээр дутсаных биш. Давтагддаг хэв маягаа хараагүй байхад ямар ч оролдлого эхнээсээ л хүндэрдэг.</p><div class="methodology-pillars"><article><h3>Хоолны зан үйлийн судалгаа</h3><p>Хязгаарлалт, цадалт, хяналт алдалтын хэв маяг хэрхэн үүсдэг вэ?</p></article><article><h3>Сэтгэл хөдлөлийн хооллолт</h3><p>Стресс, уйтгар, ганцаардал идэх зан үйлд хэрхэн нөлөөлдөг вэ?</p></article><article><h3>Нойр ба амьдралын хэмнэл</h3><p>Нойр, ядаргаа, хуваарь жинтэй хэрхэн холбогддог вэ?</p></article><article><h3>Аюулгүй байдлын дохио</h3><p>Хариултаас мэргэжлийн тусламж шаардлагатай байж болох дохио илэрвэл тайланд анхааруулга, цаашдын чиглэл өгнө.</p></article></div><p>Үнэлгээ нь нэг асуулт, нэг оноогоор дүгнэдэггүй — хариултын давтамж, хоорондын уялдаагаар хамгийн чухал хэв маягийг эрэмбэлдэг.</p><a class="text-link" href="/methodology" data-route>Арга зүйн дэлгэрэнгүйг унших</a></section>
    <section class="faq-section" aria-labelledby="faq-title"><p class="eyebrow">Тодорхой хариултууд</p><h2 id="faq-title">Асуух зүйл байвал</h2><details><summary>Энэ үнэлгээний зориулалт юу вэ?</summary><p>Жин хасахад тань нөлөөлж буй давтагддаг хэв маяг, далд зуршлыг таньж ойлгох, аль чиглэлээс эхэлж ажиллахаа тодорхойлоход туслах өөрийгөө танин мэдэх хэрэгсэл юм.</p></details><details><summary>Энэ эмнэлгийн онош уу?</summary><p>Үгүй. Энэ үнэлгээ эмнэлгийн онош тавихгүй, хооллолтын эмгэгийг оношлохгүй бөгөөд эмч, сэтгэлзүйч, хоолзүйчийн үнэлгээг орлохгүй. Харин мэргэжлийн хүнтэй уулзахдаа юуг ярилцахаа мэдчихсэн очиход тань тусална.</p></details><details><summary>Миний мэдээлэл хэрхэн хадгалагдах вэ?</summary><p>Таны хариулт бусад хэрэглэгчид харагдахгүй. Мэдээлэл хадгалах, боловсруулах нөхцөлийг <a href="/privacy" data-route>Нууцлалын бодлогоос</a> үзнэ үү.</p></details><details><summary>Төлбөр төлсний дараа юу болох вэ?</summary><p>Төлбөр баталгаажмагц тест шууд нээгдэж, дуусмагц дэлгэрэнгүй тайлан тань бэлэн болно. Имэйл хаяг, хамгаалалтын кодоороо тайлангаа дахин нээж үзэх боломжтой.</p></details><details><summary>Төлбөр төлсөн ч эрх нээгдэхгүй бол яах вэ?</summary><p><a href="/support" data-route>Дэмжлэгтэй холбогдоорой.</a></p></details><details><summary>Асуулт хүнд санагдвал яах вэ?</summary><p>Түр завсарлаад дараа нь үргэлжлүүлж болно. Зарим асуулт хувийн мэдрэмж хөндөж болох ч зөв хариулт, буруу хариулт гэж байхгүй — үнэнч хариулт л хамгийн үнэ цэнэтэй тайлан гаргана.</p></details></section>
    <section class="closing-section" aria-labelledby="closing-title"><h2 id="closing-title">Өөрийгөө ойлгох нь өөрчлөлтийн эхний алхам</h2><p>Энэ үнэлгээ таныг шүүхгүй. Олон удаагийн оролдлого, тэр болгоны ард үлдсэн урам хугаралт — эдгээр нь таны сул тал биш, хараахан олж хараагүй хэв маягийн чинь ул мөр юм.</p><p>Хэв маягаа тод харсан хүн дараагийн оролдлогоо өөр эхлүүлдэг.</p><p class="methodology-principle">Энэ бол өөртэйгөө тэмцэхээ больж, өөрийгөө ойлгож эхлэх цэг.</p><a class="button primary-cta" href="/assessment/start" data-route data-primary-cta>${primary}</a><p class="landing-microcopy">${micro}</p></section>
  </main>${footer()}</div>`;
}
