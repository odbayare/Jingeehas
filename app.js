  ...
  return `<section class="scientific-methods-box" aria-labelledby="scientific-methods-title">
    ...
    <div id="scientific-methods-details" class="scientific-methods-details">
      <div class="scientific-methods-grid">
        <article><h3>Биопсихосоциал загвар</h3><p>Жинтэй холбоотой асуудлыг зөвхөн хооллолт, дасгал хөдөлгөөнөөр тайлбарлахгүйгээр бие махбод, сэтгэлзүй, зан үйл, амьдралын хэв маяг болон орчны харилцан нөлөөллөөр авч үздэг.</p></article>
        <article><h3>Dutch Eating Behavior Questionnaire <span class="method-acronym">— DEBQ</span></h3><p>Сэтгэл хөдлөлөөр идэх, гаднын өдөөлтөд хариу үйлдэл үзүүлж идэх, хооллолтоо хэт хязгаарлах хэв маягийг судалдаг.</p></article>
        <article><h3>Three-Factor Eating Questionnaire <span class="method-acronym">— TFEQ</span></h3><p>Хооллолтын танин мэдэхүйн хяналт, хяналт алдсан хооллолт, өлсгөлөн болон идэх хүчтэй хүслийг судалдаг.</p></article>
        <article><h3>Binge Eating Scale <span class="method-acronym">— BES</span></h3><p>Хяналтгүй болон хэтрүүлэн идэх үеийн зан үйл, хяналт алдсан мэдрэмж, гэмшил, ичгүүр зэрэг сэтгэлзүйн шинжийг судалдаг.</p></article>
        <article><h3>Night Eating Questionnaire <span class="method-acronym">— NEQ</span></h3><p>Орой болон шөнийн хооллолт, өглөөний хоолны дуршил, нойр болон хооллолтын хэмнэлийн холбоог судалдаг.</p></article>
        <article><h3>Когнитив-зан үйлийн функциональ шинжилгээ</h3><p>Өдөөгч нөхцөл, бодол, сэтгэл хөдлөл, идэх зан үйл болон түүний үр дагаврын хоорондын давтагддаг холбоог тодорхойлдог.</p></article>
      </div>
