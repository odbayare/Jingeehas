...
function menstrualCycleContextHtml() {
  ...
  const confidenceCopy = evidence.confidenceLow
    ? `<p>Хэрвээ мөчлөг тогтмол биш, дааврын жирэмслэлтээс хамгаалах хэрэгсэл хэрэглэдэг, PCOS-той эсвэл сэжигтэй, төрсний дараах/хөхүүл үе, перименопаузын үе байвал өдрөөр нь хатуу тайлбарлах хэрэггүй. Энэ хэсгийг онош биш, зүгээр ажиглах нэмэлт мэдээлэл гэж уншаарай.</p>`
    : "";
  ...
  const appetiteCopy = evidence.premenstrual
    ? `<p>Сарын тэмдэг ирэхийн өмнөх хэдэн өдөрт өлсөх, амттай юм хүсэх, ядрах, сэтгэл савлах нь илүү мэдрэгддэг гэж та тэмдэглэсэн байна. Энэ нь таны сул тал гэсэн үг биш. Зарим хүнд тэр өдрүүдэд идэх хүсэл илүү хүчтэй болдог.</p><p>Ийм үед өөрийгөө илүү чанга барих гэж шахвал “маргаашаас чанга барина” гэсэн тойрог хүчтэй болж магадгүй. Илүү зөв эхлэл нь тогтмол хоол, урьдчилж бэлдсэн зөөлөн сонголт, өөрийгөө буруутгахгүй тэмдэглэл байна.</p>`
...
function menstrualCycleProfessionalSummaryHtml() {
  ...
  return `
    <div class="report-section menstrual-cycle-note">
      ...
      <p>Сарын тэмдэг ирэхгүй удах, гэнэт их өөрчлөгдөх, хоол хасалт, жин огцом буурах эсвэл хэт их дасгал давхцаж байгаа бол үүнийг ердийн жин хасалтын сорил гэж үзэхгүй. Эхлээд мэргэжлийн хүнтэй ярилцаж, хоол/дасгалын ачаалал биеийн дохиотой яаж холбоотой байж болохыг аюулгүйгээр тодруулах нь зөв.</p>
    ...
    <section class="screen">
      <div class="panel stack paywall-panel">
        <div class="report-section">
          ...
          ${mode.mode === "check" ? `<p class="danger-copy">Нэг зүйл анхаарал татаж байна. Нэмэлтээр нэг биеийн дохиог шалгуулахад илүүдэхгүй. Энэ нь онош гэсэн үг биш.</p>` : ""}
        </div>
        <div class="report-section">
...
function ordinaryReportOpeningTitle(primaryKey, tags = []) {
  if (shouldUseMenstrualCycleContextVoice("rewardDeficit")) {
    return "Сарын тэмдэг ирэхийн өмнөх өдрүүдэд идэх хүсэл өөр болж байна";
  }
  if (primaryKey === "executive" || primaryKey === "decisionDefault" || tags.includes("executive_load") || tags.includes("default_delivery")) {
    return "Орой хоол бодох тэнхээ үлдэхгүй үе байна";
  }
  if (primaryKey === "regulation" || tags.includes("food_as_regulation")) {
    return "Стрессийн дараа хоол түр амрах газар болж байна";
  }
  if (primaryKey === "collapse" || primaryKey === "perfectionism" || tags.includes("control_collapse")) {
    return "Нэг хазайхад бүх өдөр дууссан мэт санагддаг";
  }
  if (primaryKey === "hungerSafety" || tags.includes("hunger_safety")) {
    return "Удаан юм идээгүй үед орой бие яарч эхэлдэг";
  }
  if (primaryKey === "reward" || primaryKey === "rewardDeficit" || tags.includes("reward_pull")) {
    return "Өдөржин өөрийгөө хойш тавьсны дараа орой амттай зүйл татдаг";
  }
  if (primaryKey === "cue" || tags.includes("cue_trigger")) {
    return "Хоол нүдэнд өртөхөөр идмээр санагддаг";
  }
  return "Таны өдөрт нэг гацаад байдаг хэсэг байна";
}
...
const REPORT_VOICE_LIBRARY = {
  executive: {
    ...
    notProblem: "Гол нь мэдэхгүйдээ биш. Орой тэнхээ дууссан үед энгийн зүйл ч хүнд болдог. Тийм үед хамгийн амар сонголт түрүүлдэг.",
    avoid: ["Орой олон сонголттой үлдэх", "Хэт төвөгтэй хоол бэлдэх", "Өдөр бүр төгс хийх гэж шахах", "Оройн хоолыг шууд бүрэн хорих"],
    firstStep: "Эхний жижиг өөрчлөлт бол орой бодохгүй ашиглаж болох хоёр бэлэн хоол сонгох. Үүнийг тэнхээтэй үедээ шийд.",
    experiment: [
  ...
  regulation: {
    ...
    notProblem: "Асуудал хоолондоо биш. Стресс өндөр үед хоол хамгийн ойр амсхийх газар болж байна.",
  ...
  collapse: {
    ...
    notProblem: "Асуудал нэг удаа төлөвлөгөө алдсандаа биш. Гол нь буцаад хэвийн үргэлжлэх жижиг зам харагдахгүй болдог.",
  ...
  hungerSafety: {
    ...
    notProblem: "Асуудал орой идсэндээ биш. Өдөр хоолны зай хэт уртсахад орой бие хамгаалах гэж яардаг.",
  ...
  cue: {
    ...
    notProblem: "Асуудал хүсэл зориг сулдаа биш. Хоол харагдах, үнэртэх, апп нээгдэх зэрэг ойрын дохио идэх бодлыг түрүүлж асаадаг.",
...
function getSimpleResultSummary(primaryKey, context = {}) {
  ...
  const summaries = {
    executive: {
      stuckMoment: "Орой болоход хоол бодох тэнхээ үлдэхгүй байна.",
      meaningBullets: [
      ...
      firstStep: "Орой дахин бодохгүй ашиглах 2 бэлэн хоолны сонголт урьдчилж тогтоо.",
    ...
    hungerSafety: {
      stuckMoment: "Удаан юм идээгүй байх үед орой бие яараад эхэлдэг.",
      meaningBullets: [
    ...
    rewardDeficit: {
      stuckMoment: "Өдөржин өөрийгөө хойш тавьсны дараа орой амттай зүйл өөртөө өгөх нэг жижиг зүйл болдог.",
      meaningBullets: [
    ...
    cue: {
      stuckMoment: "Өлсөөгүй байсан ч хоол нүдэнд өртөхөөр идмээр санагддаг.",
      meaningBullets: [
  ...
  return `
    <div class="report-section simple-result">
      ...
      ${cycleEvidence.premenstrual ? `<div class="card stack">
        ...
        <p>Хэрвээ энэ үе сарын тэмдэг ирэхийн өмнөх өдрүүдтэй давхцдаг бол өлсөх, амттай юм хүсэх, ядрах, сэтгэл савлах нь илүү хүчтэй мэдрэгдэж болно. Энэ нь онош биш. Зүгээр л тэр өдрүүдэд хэт хатуу дүрэм биш, арай зөөлөн бэлэн төлөвлөгөө хэрэгтэй байж магадгүй гэсэн сануулга.</p>
      </div>` : ""}
    </div>
    <div class="report-section">
...
function reportEvidenceNote(voiceKey, isOneTime) {
  if (isOneTime) {
    return "Энэ тайлбар таны өгсөн мэдээлэл, бичсэн богино тайлбар дээр тулгуурласан. 7 хоногийн тэмдэглэл хийвэл аль өдөр, ямар үед илүү хүчтэй болдгийг илүү сайн ялгана.";
  }
  return {
    ...
    <section class="screen">
      <div class="panel">
        <div class="report-section">
          ...
          <p class="muted">Доорх нь таны өгсөн мэдээллээс гарсан эхний тайлбар. Өөрийгөө буруутгах гэж биш, өдөрт яг хаана хэцүү болдгийг тайван харах гэж уншаарай.</p>
        </div>
        ...
        <div class="report-section">
          ...
          <p>Тэр үед хоол зүгээр нэг хоол биш байсан байж болно. Хоол танд түр амсхийх, тэнхээ орох, эсвэл өөртөө нэг юм өгсөн мэдрэмж өгч байсан байж магадгүй.</p>
        ...
        ${isOneTime ? `<div class="report-section">
          ...
          <p>Хэрвээ үүнийг илүү бодит өдөр тутмын түвшинд ялгахыг хүсвэл 7 хоногийн богино тэмдэглэлээр дараах хэсгүүдийг тодруулж болно.</p>
    ...
    <section class="screen">
      <div class="panel">
        ...
        <div class="report-section">
          ...
          ${mode.mode === "check" ? `<p class="danger-copy">Нэмэлтээр нэг биеийн дохиог шалгуулахад илүүдэхгүй. Тиймээс эхний туршилт илүү зөөлөн, аюулгүй байна.</p>` : ""}
        </div>
        <div class="report-section">
