...
function renderMultiFactorReport(full) {
  ...
  const planFields = plan ? [["Хугацаа", plan.duration], ["Хийх хувилбар", plan.option], ["Гэмтэл, өвдөлтийн зааг", plan.injuryBoundary], ["Зардлын зааг", plan.costBoundary], ["Зангуу цаг, үйл явдал", plan.anchor], ["Давтамж", plan.frequency], ["Юуг тэмдэглэх вэ?", plan.record], ["Амжилтыг хэрхэн хэмжих вэ?", plan.success], ["Доод хувилбар", plan.fallback], ["Алгассан өдрийн дүрэм", plan.maintenanceRule]].filter(([, value]) => value) : [];
