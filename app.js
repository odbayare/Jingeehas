...
const publicMechanismCopy = {
  ...
  hungerSafety: { name: "Хоол хоорондын зай уртсаж, орой яаран хооллох үе", short: "Хоолны зай уртсах үе" },
  ...
  collapse: { name: "Нэг хазайлтын дараа хэвийн үргэлжлэхэд хэцүү болдог мөч", short: "Төлөвлөгөөгөө хэвийн үргэлжлүүлэхэд саад болдог үе" },
...
const stageOneQuestions = [
  ...
  { id: "S1-W05", module: "Past attempts", type: "text", text: "Өмнө нь туршиж үзсэн аргуудаас аль нь 2 долоо хоногоос дээш хугацаанд тогтвортой үргэлжлэхэд хамгийн хэцүү байсан бэ? Шалтгааныг нь товч хуваалцана уу.", voice: true },
  { id: "S1-W06", module: "Past attempts", type: "single", text: "Хоолны төлөвлөгөө тань бага зэрэг зөрчихөд танд ихэвчлэн ямар бодол төрдөг вэ?", options: ["Дараагийн хоолноос хэвийн үргэлжлүүлье", "Өнөөдөр өнгөрлөө, маргаашаас", "Маргааш илүү чанга барина", "Би угаасаа чаддаггүй юм байна", "Одоо бүх юм дууссан", "Тодорхой бодолгүй"], scores: { "Өнөөдөр өнгөрлөө, маргаашаас": ["collapse"], "Өнөөдөр алдсан, маргаашаас": ["collapse"], "Маргааш илүү чанга барина": ["collapse"], "Маргааш илүү чанга": ["collapse"], "Одоо бүх юм дууссан": ["collapse"], "Би угаасаа чаддаггүй юм байна": ["collapse"], "Би угаасаа чаддаггүй": ["collapse"] } },
    ...
    <section class="screen">
      <div class="panel" data-report-output>
        <div class="report-section">
          ...
          <p class="muted">Доорх тайлан таны хариултаас хамгийн хүчтэй харагдаж буй нэг боломжит хэв маягийг тайван харуулах зорилготой.</p>
        </div>
        <div class="report-section">
          <h3>1. Гол гацалт</h3>
          <p>${publicHtml(summary.stuckMoment)}</p>
