...
const publicMechanismCopy = {
  reward: { name: "Өөртөө нэг таатай зүйл өгөх үе", short: "Сэтгэл санаагаа баярлуулахыг хүсэх үе" },
  regulation: { name: "Стресс үед хоолоор амсхийх үе", short: "Стрессийн дараа хоолоор тайвшрах хандлага" },
  hungerSafety: { name: "Хоол хоорондын зай уртсаж, орой яаран хооллох үе", short: "Хоол хоорондын зай уртсах" },
  glucose: { name: "Бие эвгүйрхэхээс санаа зовох үе", short: "Бие эвгүйрхэх үе" },
  satiety: { name: "Биеийн цадах мэдрэмж бүдгэрэх үе", short: "Цадах дохио" },
  cue: { name: "Хоол харагдах, үнэртэхээр татах үе", short: "Хоол харагдах, үнэртэхэд идэх хүсэл нэмэгдэх" },
  collapse: { name: "Нэг хазайлтын дараа хэвийн үргэлжлэхэд хэцүү болдог мөч", short: "Нэг удаа хазайсны дараа хэвийн үргэлжлүүлэхэд хэцүү болох" },
  executive: { name: "Орой хоол шийдэх тэнхээ дуусах үе", short: "Орой хоол шийдэхэд хүнд санагдах үе" },
  circadian: { name: "Нойр ба тэнхээний зөрүү", short: "Нойр ба өдрийн эрч хүч" },
  ...
  autonomy: { name: "Хэт хатуу дүрмийг эсэргүүцэх хандлага", short: "Өөрийн сонголт" },
  physiological: { name: "Өлссөн үед бие махбод хүчтэй хариу үйлдэл үзүүлэх мөч", short: "Биеийн хариу" },
  decisionDefault: { name: "Бэлэн бөгөөд хялбар сонголт хийх хандлага давамгайлах үе", short: "Бэлэн сонголт" },
  rewardDeficit: { name: "Тухайн өдөр сэтгэл ханамж, таатай мэдрэмж дутагдсан үе", short: "Таатай зүйл дутсан" },
  roleOverload: { name: "Өөрийн хэрэгцээг хойш тавьсан өдөр", short: "Өөрийгөө хойш тавих" },
  shameAvoidance: { name: "Ичих, нуух мэдрэмжээс холдох үе", short: "Ичгүүр, таагүй мэдрэмж хуримтлагдахаас сэргийлэх" },
...
const stageOneQuestions = [
  { id: "S1-C00", module: "Warm start", type: "info", text: "Энэхүү сорил нь таныг шүүмжлэх зорилгогүй юм. Жингээ хасахаар хичээх үед яг ямар нөхцөл байдал, сэтгэл зүйн мэдрэмж, алжаал ядаргаа болон орчны нөлөөлөл давхцахад хооллох зуршил тань хэрхэн өөрчлөгддөгийг хамтдаа шинжлэн олж мэдэх зорилготой билээ." },
  ...
  { id: "S1-A02", module: "Согтууруулах ундаа ба тамхи", type: "multi", text: "Согтууруулах ундаа хэрэглэсэн үед таны хоолны сонголт ихэвчлэн яаж өөрчлөгддөг вэ?", options: ["Онц өөрчлөгддөггүй", "Зууш, шарсан эсвэл давслаг зүйл нэмэгддэг", "Оройн хоолны хэмжээ нэмэгддэг", "Шөнө орой юм идэх гээд байдаг", "Маргааш нь биеийн тавгүйрхлээ намдаах гэж их иддэг", "Маргааш нь амттай, тослог, давслаг зүйл илүү хүсдэг", "Нойр муудаж, маргааш хоолны хэмнэл алдагддаг", "Найз нөхдийн дунд татгалзах хэцүү болдог", "Сайн мэдэхгүй"], max: 3, scores: { "Зууш, шарсан эсвэл давслаг зүйл нэмэгддэг": ["social", "cue"], "Оройн хоолны хэмжээ нэмэгддэг": ["hungerSafety", "social"], "Шөнө орой юм идэх гээд байдаг": ["circadian", "cue"], "Маргааш нь биеийн тавгүйрхлээ намдаах гэж их иддэг": ["hungerSafety", "physiological"], "Маргааш нь амттай, тослог, давслаг зүйл илүү хүсдэг": ["reward", "circadian"], "Нойр муудаж, маргааш хоолны хэмнэл алдагддаг": ["circadian"], "Найз нөхдийн дунд татгалзах хэцүү болдог": ["social"] } },
  { id: "S1-A03", module: "Согтууруулах ундаа ба тамхи", type: "multi", text: "Согтууруулах ундаа хэрэглэсний маргааш танд аль нь илүү ойр тохиолддог вэ?", options: ["Их өлсдөг", "Давслаг, шөлтэй, тослог хоол хүсдэг", "Амттай зүйл хүсдэг", "Кофе, ундаа, чихэрлэг зүйл нэмэгддэг", "Хөдөлгөөн хийх хүсэл багасдаг", "Өдөржин ядарч, орой дахин их иддэг", "Маргааш нь хоолоо илүү чанга барина гэж боддог", "Онц өөрчлөлтгүй", "Сайн мэдэхгүй"], max: 3, scores: { "Их өлсдөг": ["hungerSafety"], "Давслаг, шөлтэй, тослог хоол хүсдэг": ["reward", "physiological"], "Амттай зүйл хүсдэг": ["reward"], "Кофе, ундаа, чихэрлэг зүйл нэмэгддэг": ["circadian", "reward"], "Хөдөлгөөн хийх хүсэл багасдаг": ["circadian"], "Өдөржин ядарч, орой дахин их иддэг": ["circadian", "hungerSafety"], "Маргааш нь хоолоо илүү чанга барина гэж боддог": ["collapse"] } },
  { id: "S1-T01", module: "Согтууруулах ундаа ба тамхи", type: "single", text: "Та одоогоор тамхи татдаг уу?", options: ["Үгүй", "Өмнө татдаг байсан, одоо больсон", "Хааяа татдаг", "Өдөр бүр татдаг", "Хариулахгүй"], scores: { "Өмнө татдаг байсан, одоо больсон": ["regulation"], "Хааяа татдаг": ["regulation"], "Өдөр бүр татдаг": ["regulation"] } },
  ...
  { id: "S1-L01", module: "Executive load", type: "single", text: "Юу хийхээ мэдэж байсан ч, хийх эрч хүч хүрэлцэхгүй үе танд хэр олон тохиолддог вэ?", options: ["Бараг үгүй", "Заримдаа", "7 хоногт хэд хэд", "Бараг өдөр бүр", "Маш их"], scores: { "7 хоногт хэд хэд": ["executive"], "Бараг өдөр бүр": ["executive"], "Маш их": ["executive"] } },
...
const dimensionByModule = {
  ...
  "Согтууруулах ундаа ба тамхи": ["D06", "D13", "D15", "D17"],
  "Хөдөлгөөний боломж": ["D13", "D22"],
  "Hunger-safety": ["D07"],
...
function optionSignals(label) {
  ...
  if (/алхалт|фитнес|хүчний дасгал|гэрийн дасгал|иог|сунгалт|усанд сэлэх|дугуй|спиннинг|бүжиг|багийн спорт|хөдөлгөөн/.test(text)) add(["movement_feasibility_context"], ["D13", "D22"], [mechanismNamesByKey.executive], ["first_leverage_point"]);
...
function applyScenarioPriorityRules(evidence, currentState = state) {
  ...
  if (
    hasText("найз", "найзууд", "согтууруулах ундаа", "хүмүүсийн дунд", "татгалзах", "social", "амралтын өдөр") ||
    ...
    <section class="screen">
      <div class="grid">
        <div class="panel stack">
          ...
          <p class="muted">Дотоод чанарын шалгалтаар тайлангийн чанар, асуултын ойлгомж, зарим нөхцөлд таарах байдал дээр засах зүйлс илэрсэн тул олон нийтэд төлбөртэй хувилбарыг түр хаалаа.</p>
          <ul>
  ...
  return `
    ...
    <section class="screen">
      <div class="grid">
        ...
        <aside class="aside">
          <div class="card">
            <h3>Таны хариултаас одоогоор тодорч буй зүйл</h3>
...
function reportMode() {
  ...
  const bodySignalText = asArray(state.stageAnswers["S1-B01"]).join(" ");
  if (/гар салгалах|зүрх дэлсэх|хөлрөх|толгой эргэх|толгой өвдөх|сахар унасан/i.test(bodySignalText)) return { mode: "check", title: "Биеийн талаа давхар шалгах дохио байна" };
...
function cycleMapSteps(primaryKey, tags = allReportTags()) {
  if (primaryKey === "executive" || tags.includes("executive_load") || tags.includes("default_delivery")) {
    return [
      ...
      "Дараа нь гэмших эсвэл маргааш чанга барих бодол гарна",
  ...
  if (primaryKey === "reward" || tags.includes("reward_pull")) {
    return [
      ...
      "Хэрвээ өөртөө хатуу хандах мэдрэмж нэмэгдвэл маргааш хатуу барих бодол гарна",
...
function notRealProblemCopy(primaryKey, tags = allReportTags()) {
  const copies = {
    ...
    circadian: "Таны оройн идэх хүсэл зөвхөн амттай юм хүсэх биш, нойр, өдрийн сүүлийн кофе, өглөөний хоолгүй хэмнэл, оройн эрч хүчний уналттай холбоотой байж магадгүй. Тиймээс эхлэхэд хамгийн амар алхам нь таатай мэдрэмж авах хүслээ хорих биш — эхний тогтмол хоол, өдрийн сүүлийн кофегоо уух цаг, нойрыг бодолцсон оройн сонголт байна.",
...
function previousAttemptsCopy(primaryKey, tags = allReportTags()) {
  ...
  if (attempts.includes("Калори тоолох") || tags.includes("shame_guilt") || tags.includes("control_collapse")) {
    return `Өмнө хэрэглэсэн арга: ${known}. Тэмдэглэл хөтлөх нь эхэндээ бүтэц өгдөг ч гэмшил/ичгүүр эсвэл бүгдийг эсвэл юу ч биш гэж харах цикл идэвхтэй үед хариу мэдээлэл өөрөө өдөөгч нөхцөл болж болно. Илүү зөв эхлэх цэг нь өөртөө хатуу хандахгүй тэмдэглэл болон хэвийн үргэлжлүүлэх дүрэм юм.`;
  }
...
function leveragePoint(primaryKey, tags = allReportTags()) {
  ...
  return { label: "neutral_tracking", copy: "Таны эхэлж өөрчлөх хамгийн амар цэг: өөртөө хатуу хандахгүй тэмдэглэх. Яагаад гэвэл давтамжийг ичгүүр биш, мэдээлэл гэж харах үед дараагийн зөв алхам тодордог." };
}
...
function selectedHiddenFunctions(primaryKey, secondaryKeys = [], tags = allReportTags()) {
  ...
  const candidates = [
    ...
    { keys: ["collapse", "shameAvoidance"], tag: "shame_guilt", name: "Ичих, нуух мэдрэмжээс зай авах", evidence: "Төлөвлөгөө тань бага зэрэг зөрчихөд гэмшиж, өөртөө хатуу хандах хандлага илэрч байгаа нь дараагийн сонголтоо зөв хийхэд саад болдог." },
...
function refinementBullets(primary, secondary = []) {
  ...
  const copy = {
    executive: [
      "Орой хоол шийдэхэд хамгийн хүнд өдөр аль нь вэ?",
...
const REPORT_VOICE_LIBRARY = {
  executive: {
    ...
    firstStep: "Авч хэрэгжүүлж болох хамгийн хялбар өөрчлөлт бол оройн хоолоо хасах биш, харин өдрийн цагаар орой идэж болох хоёр төрлийн хялбар сонголтыг урьдчилж тодорхойлох явдал юм. Энэ нь орой ядарч ирэх үед шууд хэрэглэхэд амар байх учиртай.",
    experiment: [
  ...
  regulation: {
    ...
    firstStep: "Авч хэрэгжүүлж болох хамгийн хялбар өөрчлөлт бол хоол идэхээсээ өмнө өөрийгөө хүчээр хорих биш юм. Харин ердөө 60 секунд амсхийгээд \"Би бодитоор өлсөж байна уу, эсвэл зүгээр л амрах газар хайж байна уу?\" гэдгийг ялгаж сурах явдал билээ.",
    experiment: [
  ...
  collapse: {
    ...
    needs: [
      ...
      "Гэмших мэдрэмжээс хэсэг зай авах"
    ],
    cycle: [
    ...
    firstStep: "Хамгийн хялбар эхлэх цэг бол төгс төлөвлөгөө биш. Нэг хазайлтын дараа хэрэглэх “дараагийн хоолноос хэвийн үргэлжлүүлэх” дүрэмтэй болох.",
    experiment: [
  ...
  hungerSafety: {
    ...
    firstStep: "Хамгийн хялбар эхлэх цэг бол оройг хорих биш. Өдрийн хоолны зайг хэт холдуулахгүй нэг тулгуур хоол, нэг жижиг гүүр сонголт бэлдэх.",
    experiment: [
  ...
  rewardDeficit: {
    opening: [
      ...
      "Орой болоход амттай зүйл зүгээр нэг амтлах зүйл биш, өөртөө өгч байгаа жижиг анхаарал шиг санагдаж болно."
    ],
    ...
    cycle: [
      ...
      "Дараа нь өөртөө хатуу хандах бодол орж ирж магадгүй",
    ...
    firstStep: "Авч хэрэгжүүлж болох эхний алхам бол “өөртөө цаг гарга” гэсэн том зөвлөгөө биш. Өдөр бүр өөрийн хоол эсвэл амралтын 10 минутыг үлдэгдэл цагт найдахгүй хамгаалах.",
    experiment: [
      ...
      ["Хэрвээ нэг өдөр алгасвал", "өөртөө хатуу хандахгүй. Дараагийн өдөр дахин 10 минутаас эхэл."]
    ]
  },
    menstrualCycleContext: {
      opening: [
    ...
    cycle: [
      ...
      "Амттай зүйл түр таатай мэдрэмж өгнө",
      "Дараа нь өөртөө хатуу хандах бодол орж ирж магадгүй",
      "Дараагийн удаа уян хатан төлөвлөгөө байхгүй бол энэ тойрог буцаж ирнэ"
    ],
    ...
    firstStep: "Хамгийн хялбар эхлэх цэг бол тэр өдрүүдэд өөрийгөө илүү чанга барих биш. Харин тогтмол хоол, урьдчилж сонгосон жижиг амттай сонголт, өөртөө хатуу хандахгүй тэмдэглэл бэлдэх.",
    experiment: [
      ...
      ["11-14 дахь өдөр", "уян хатан төлөвлөгөөтэй өдөр, огцом хориг тавьсан өдөр хоёрын ялгааг анзаар."],
  ...
  cue: {
    ...
    firstStep: "Эхлэхэд хамгийн амар алхам бол бүх амттай зүйлийг хорих биш. Хамгийн хүчтэй татдаг нэг зүйлийг нэг алхам холдуул. Оронд нь илүү тохирох нэг сонголтыг ойр тавь.",
    experiment: [
  ...
  circadian: {
    ...
    firstStep: "Эхлэхэд хамгийн амар алхам бол амттай зүйлээ шууд хорих биш. Өдрийн эхний хоолоо тогтмол болго. Өдрийн сүүлийн кофегоо хэзээ уухаа тогтоо. Орой 10 минут тайвшрах хугацаа гарга.",
    experiment: [
      ["Эхний 3 өдөр", "нойр, сүүлийн кофе уусан цаг, оройн эрч хүчээ л тэмдэглэ."],
  ...
  shiftWork: {
    ...
    firstStep: "Хамгийн хялбар эхлэх цэг бол ээлжийн дараах өлсөлт эхлэхээс өмнө нэг төлөвлөсөн хоол, ойр дэлгүүрийн нэг нөөц сонголт бэлдэх.",
    experiment: [
  ...
  socialWeekend: {
    ...
    notProblem: "Гол нь зөвхөн согтууруулах ундаа эсвэл хоол биш. Хүмүүс идэж, ууж байхад татгалзах эвгүй санагдаж, хамт байгаа мэдрэмжээ алдахгүй байх хэрэгцээ оролцож байна.",
    avoid: ["Амралтын өдрийн идэлтийг Даваа гарагт шийтгэж засах", "Хүмүүсийн дунд зөвхөн тэвчих гэж шахах", "Согтууруулах ундаа хэрэглэсэн үед төлөвлөгөөгүй үлдэх", "Татгалзах өгүүлбэргүй шууд нөхцөлд орох"],
    firstStep: "Гарахаасаа өмнө хэлэх нэг богино татгалзах өгүүлбэрээ бэлд.",
    experiment: [
      ["1–3 дахь өдөр", "уулзалт, согтууруулах ундаа хэрэглэсэн орой, оройн хоолтой нөхцөлд “үгүй” гэж хэлэхэд юу эвгүй санагддагийг бич."],
  ...
  postpartumContext: {
    ...
    experiment: [
      ...
      ["Хэрвээ нэг өдөр алгасвал", "өөртөө хатуу хандахгүй. Дараагийн боломжтой хүүхэд унтах цонхонд жижиг дүрмээ дахин хэрэглэ."]
    ]
  },
  perimenopauseContext: {
    opening: [
    ...
    cycle: [
      ...
      "Дараа нь өөртөө хатуу хандах эсвэл дахин чангаруулах бодол орно",
      "Биеийн өөрчлөлтийг хатуу дүгнэвэл тойрог давтагдана"
    ],
    notProblem: "Энэ нь онош биш. Өдрөөр нь хатуу тайлбарлах хэрэггүй. Гол нь бие өөрчлөгдөх тодорхойгүй мэдрэмж хяналт хайх, өөртөө хатуу хандах, орой тайвшрах зүйл хайхтай холбогдож байна.",
    ...
    firstStep: "Авч хэрэгжүүлж болох эхний алхам бол биеэ хүчээр удирдах биш. Нойр, биеийн мэдрэмж, оройн идэх хүсэл гурвыг буруутгалгүй хамт тэмдэглэ.",
    experiment: [
      ["Эхний 3 өдөр", "нойр, бие хүнд оргих, оройн тайвшрах хүсэл гарсан эсэхийг тэмдэглэ."],
      ["4-10 дахь өдөр", "орой тайвшрах нэг ачаалал багатай зан үйл болон нэг тогтмол хоолны тулгуур сонго."],
      ["11-14 дахь өдөр", "хяналтаа алдсан мэт санагдах өдөр ямар ачаалал багатай алхам бодитой байсныг ялга."],
  ...
  bodyTrustMedical: {
    ...
    needs: [
      ...
      "Өөртөө хатуу хандахгүйгээр шалгах"
    ],
    cycle: [
      ...
      "Дараа нь биедээ улам хатуу хандах бодол орж ирнэ",
      "Мэргэжлийн шалгалтгүйгээр зөвхөн дэглэмээр засах гэж оролдвол тойрог давтагдана"
    ],
    notProblem: "Энэ нь онош биш. Биеийн өөрчлөлтийг ганцаараа тайлбарлахгүй. Гол нь бие урьдчилж таахад хэцүү санагдахад хяналт хайх, бухимдах, өөртөө хатуу хандах, хэт чанга барих хандлага нэмэгдэж байна.",
    avoid: ["Биеийн өөрчлөлтийг өөрөө оношлоод орхих", "Биеийн санаа зовнилыг зөвхөн хоол хасалтаар засах", "Мэргэжлийн шалгалтыг хойш тавьж огцом хязгаарлалт эхлүүлэх", "Өөртөө хатуу хандах"],
    firstStep: "Хамгийн хялбар эхлэх цэг бол өөрийгөө чангаруулах биш. Биеийн өөрчлөлт, хоолны хариу, санаа зовнилоо тэмдэглээд хэрэгтэй бол мэргэжлийн хүнтэй шалгуулах асуултаа бэлд.",
    experiment: [
      ...
      ["Хэрвээ нэг өдөр алгасвал", "өөртөө хатуу хандахгүй. Тэмдэглэл болон ачаалал багатай хоолны тулгуур руугаа буц."]
    ]
  }
};
...
function medicalContextCopy(answers = state.stageAnswers || {}) {
  ...
  const copy = {
    ...
    perimenopause: {
      ...
      hiddenSentence: "Бие өөрчлөгдөж байгаа мэт санагдах үед хяналтаа буцаах, өөртөө хатуу хандах, орой тайвшрах зүйл хайх мэдрэмж нэмэгдэж байна.",
    ...
    postpartum: {
      ...
      avoidLabel: "Төрсний дараах ачааллыг тооцохгүй огцом хязгаарлалт эхлүүлэх",
...
function reportVoiceFor(primaryKey, tags = []) {
  ...
  if (voiceKey === "bodyTrustMedical") {
    ...
    return {
      ...
      notProblem: `Энэ нь онош биш. ${medicalCopy.checkSentence} Гол нь бие урьдчилж таахад хэцүү санагдахад хяналт хайх, бухимдах, өөртөө хатуу хандах, хэт чанга барих хандлага нэмэгдэж байна.`,
      avoid: [
...
function getSimpleResultSummary(primaryKey, context = {}) {
  ...
  if (voiceKey === "menstrualCycleContext") {
    return {
      ...
      firstStep: "Сарын тэмдэг ирэхийн өмнөх өдрүүдэд хэт хатуу эхлэхийн оронд тогтмол хоол, урьдчилсан жижиг амттай сонголт, өөртөө хатуу хандахгүй тэмдэглэл бэлд.",
  ...
  const summaries = {
    ...
    collapse: {
      ...
      avoidForNow: "Нэг алдааны дараа бүхнийг дахин эхлүүлэх хэт чанга төлөвлөгөөнөөс түр зайлсхий."
    },
    hungerSafety: {
    ...
    rewardDeficit: {
      ...
      meaningBullets: [
        "Энэ нь зүгээр нэг амттай зүйл хүссэн асуудал биш.",
    ...
    socialWeekend: {
      ...
      meaningBullets: [
        "Гол нь зөвхөн согтууруулах ундаа эсвэл хоол биш.",
...
function surfaceContextInsight(voiceKey, answers = state.stageAnswers || {}) {
  ...
  if (voiceKey === "perimenopauseContext" || hasText("перименопауз")) {
    return {
      ...
      hidden: "Бие өөрчлөгдөх нь тодорхой бус санагдах үед хяналтаа буцааж авах, өөртөө хатуу хандах, эсвэл орой тайвшрах зүйл хайх мэдрэмж нэмэгдэж байж магадгүй.",
      surfaceCopy: "Мөчлөг, нойр, биеийн өөрчлөлт таны өдөрт бодитоор нөлөөлж байна.",
      hiddenCopy: "Бие өөрчлөгдөх нь тодорхой бус санагдах үед хяналтаа буцааж авах, өөртөө хатуу хандах, эсвэл орой тайвшрах зүйл хайх мэдрэмж нэмэгдэж байна."
    };
  }
  if (voiceKey === "socialWeekend" || hasText("согтууруулах ундаа", "найз", "найзууд", "хүмүүсийн дунд", "арга хэмжээ", "татгалзах")) {
    return {
      surface: "найз нөхөд, согтууруулах ундаа хэрэглэсэн орой, амралтын өдрийн орчин",
      ...
      surfaceCopy: "Амралтын өдөр найз нөхөд, согтууруулах ундаа хэрэглэсэн орой, оройн хоол хамт давхцдаг.",
  ...
  if (hasText("жирэмслэлтээс хамгаалах", "дааврын", "эмийн", "эмчилгээ", "эм хэрэгл")) {
    if (hasAnswer("эм") || hasText("жирэмслэлтээс хамгаалах", "дааврын", "эмийн", "эмчилгээ", "эм хэрэгл")) {
      ...
      return {
        surface,
        hidden: "Бие өөрчлөгдөх үед “би хяналтаа алдаж байна” гэсэн мэдрэмж нэмэгдэж, түүнийгээ засах гэж хэт чанга барих эсвэл өөртөө хатуу хандах тойрог эхэлж байж магадгүй."
      };
    }
    if (hasText("pcos", "тогтмол биш", "тогтмол бус", "сахар", "даралт")) {
      return {
        surface: "мөчлөг тогтмол бус, PCOS эсвэл биеийн хэмжилтийн санаа зовнил",
        hidden: "Бие урьдчилж таахад хэцүү санагдах үед хяналтаа буцааж авах гэсэн оролдлого, өөртөө хатуу хандах, хэт чанга барих хүсэл нэмэгдэж байж магадгүй."
      };
    }
    const surface = hasText("жирэмслэлтээс хамгаалах", "дааврын")
      ? "эм эсвэл жирэмслэлтээс хамгаалах бэлдмэл"
  ...
  if (hasText("зураг", "толь", "бусдад харагдах", "нуух", "ичих")) {
    return {
      ...
      hidden: "Биеэ нуух, харагдахаас зугтах, өөртөө хатуу хандах мэдрэмж нэмэгдэхэд хоол тэр тавгүй мэдрэмжээс түр зай авах арга болж байж магадгүй."
    };
  }
...
function foodFunctionIntro(voiceKey) {
  return {
    ...
    socialWeekend: "Тэр үед хоол, согтууруулах ундаа хэрэглэсэн оройн зууш нь хүмүүсийн дунд эвтэйхэн байх, татгалзах эвгүй мэдрэмжээс гарах арга болж байна.",
...
function reportEvidenceNote(voiceKey) {
  ...
  return {
    ...
    socialWeekend: "Та амралтын өдөр найз нөхөд, согтууруулах ундаа хэрэглэсэн орой, оройн хоол, хүмүүсийн дунд татгалзах эвгүй мэдрэмж давхцдаг гэж тэмдэглэсэн.",
...
function wp78AnswerText(questionId, answers = state.stageAnswers) {
  return wp78AnswerValues(questionId, answers).join(", ");
}

function wp78HasAny(questionId, expected = [], answers = state.stageAnswers) {
  const values = wp78AnswerValues(questionId, answers);
...
function wp78HasTextIn(questionIds = [], patterns = [], answers = state.stageAnswers) {
  const joined = questionIds.flatMap(questionId => wp78AnswerValues(questionId, answers)).join(" ").toLowerCase();
  return patterns.some(pattern => joined.includes(String(pattern).toLowerCase()));
}

function wp78EvidenceReceipts(insights, answers = state.stageAnswers) {
  const receipts = [];
  const add = (questionId, label) => {
    const value = wp78AnswerText(questionId, answers);
    if (value) receipts.push(`${label}: ${value}`);
  };
  add("S1-W04", "Өмнө туршсан арга");
  add("S1-W06", "Дэглэм зөрөх үеийн бодол");
  add("S1-F01", "Төлөвлөөгүй идэхийн өмнөх дохио");
  add("S1-V01", "Өөрийн тайлбар");
  add("S1-V03", "Өмнөх арга үргэлжлэхэд саад болсон зүйл");
  add("S1-V04", "Тогтвортой үргэлжлэхэд туслах нөхцөл");
  add("S1-A01", "Согтууруулах ундаа хэрэглэх давтамж");
  add("S1-A02", "Согтууруулах ундаа хэрэглэсэн үеийн хоолны өөрчлөлт");
  add("S1-A03", "Согтууруулах ундаа хэрэглэсний маргааш");
  add("S1-T02", "Тамхи, кофе, стресс, зуушны холбоо");
  add("S1-MV01", "Бодитоор хийж болох хөдөлгөөн");
  add("S1-MV02", "Хөдөлгөөний саад");
...
function wp78ReportInsights(primaryKey, secondary = [], tags = [], answers = state.stageAnswers) {
  const clusters = [];
  const addCluster = (key, title, evidence, meaning, avoid = [], step = "") => {
    if (!clusters.some(item => item.key === key)) clusters.push({ key, title, evidence, meaning, avoid, step });
  };
  const alcoholUse = wp78HasAny("S1-A01", ["Ховор хэрэглэдэг", "Сард хэд хэдэн удаа хэрэглэдэг", "7 хоногт 1–2 удаа хэрэглэдэг", "7 хоногт 3 ба түүнээс олон удаа хэрэглэдэг"], answers);
  const alcoholFoodLoop = wp78HasAny("S1-A02", ["Зууш, шарсан эсвэл давслаг зүйл нэмэгддэг", "Оройн хоолны хэмжээ нэмэгддэг", "Шөнө орой юм идэх гээд байдаг", "Маргааш нь биеийн тавгүйрхлээ намдаах гэж их иддэг", "Маргааш нь амттай, тослог, давслаг зүйл илүү хүсдэг", "Нойр муудаж, маргааш хоолны хэмнэл алдагддаг", "Найз нөхдийн дунд татгалзах хэцүү болдог"], answers);
  const alcoholNextDay = wp78HasAny("S1-A03", ["Их өлсдөг", "Давслаг, шөлтэй, тослог хоол хүсдэг", "Амттай зүйл хүсдэг", "Кофе, ундаа, чихэрлэг зүйл нэмэгддэг", "Хөдөлгөөн хийх хүсэл багасдаг", "Өдөржин ядарч, орой дахин их иддэг", "Маргааш нь хоолоо илүү чанга барина гэж боддог"], answers);
  if (alcoholUse && (alcoholFoodLoop || alcoholNextDay || wp78HasAny("S1-F01", ["Согтууруулах ундаа хэрэглэсний дараа эсвэл маргааш нь идмээр болсон"], answers))) {
    addCluster(
      "alcohol",
      "Согтууруулах ундаа хэрэглэсэн орой ба маргаашийн тойрог",
      "Согтууруулах ундаа хэрэглэсэн орой + зууш/оройн хоол + маргаашийн биеийн тавгүйрхэл + нойр/ядаргаа + дараагийн өдөр чанга барих бодол хамт давтагдах боломжтой.",
      "Согтууруулах ундаа өөрөө илчлэгтэй. Мөн хэрэглэсэн үед нойр, хоолны сонголт, маргаашийн өлсөлт, давслаг/тослог хоол хүсэх мэдрэмж хамт өөрчлөгдөж болно. Энэ нь нэг шөнийн асуудал биш, дараагийн өдрийн хэт чанга барих бодолтой нийлээд давталт үүсгэж магадгүй.",
      ["согтууруулах ундаа хэрэглэсний маргааш огцом хасалт хийх", "маргааш нь хоолоо шийтгэл шиг хэт чанга барих", "нойр муу үед өндөр хүчтэй дасгал шахах"],
      "Согтууруулах ундаа хэрэглэсэн оройн өмнө маргаашийн эхний хоол, ус, давслаг/тослог хүсэл гарахад авах нэг зөөлөн сонголтоо урьдчилж бэлд."
    );
  }
  if (
    wp78HasAny("S1-F01", ["Татгалзах эвгүй байсан"], answers) ||
    wp78HasTextIn(["S1-V01"], ["татгалзах эвгүй", "найзууд", "хүмүүсийн дунд"], answers) ||
    primaryKey === "social"
  ) {
    addCluster("social", "Хүмүүсийн дунд татгалзахад эвгүй санагдах", "Найз нөхөд, хүмүүсийн дунд татгалзах эвгүй мэдрэмж хоолны сонголттой давхцаж байна.", "Энэ нь хүсэл зориг сул гэсэн үг биш. Social нөхцөлд хамт байгаа мэдрэмжээ алдахгүй байх хэрэгцээ бодит байдаг бөгөөд тухайн мөчид тайлбар бодох хэцүү тул урьдчилсан богино өгүүлбэр хэрэгтэй.", ["очсон хойноо шууд шийдэх гэж оролдох", "татгалзах эвгүй мэдрэмжийг буруутгах"], "Гарахаасаа өмнө хэлэх нэг богино татгалзах өгүүлбэрээ бэлд.");
  }
  if (
    wp78HasAny("S1-W06", ["Өнөөдөр нэгэнт өнгөрлөө, маргаашаас эхэлье гэж боддог", "Маргааш илүү чанга барина гэж боддог", "Би ер нь чаддаггүй юм байна гэж боддог", "Одоо бүх юм нурчихлаа гэж санагддаг"], answers) ||
    wp78HasAny("S1-W04", ["Хоолны хэмжээг багасгах", "Орой хоол идэхгүй байх", "Завсарлагатай мацаг / мацаг барих", "Детокс / “цэвэрлэгээ” гэж нэрлэдэг арга"], answers) ||
    primaryKey === "collapse"
  ) {
  ...
  if (wp78HasAny("S1-F01", ["Тайвширмаар санагдсан"], answers) || wp78HasAny("S1-E01", ["Хааяа", "Нэлээд давтагддаг", "Ихэвчлэн тэгдэг"], answers) || primaryKey === "regulation") {
    addCluster("stress", "Стрессийн дараа хоолоор богино хугацаанд тайвшрах", "Стресс, санаа зовнил, уур, ядаргаа нэмэгдэхэд хоол түр амсхийлгэх үүрэгтэй болж магадгүй.", "Энэ нь өлсөлт биш гэж буруутгах гэсэн үг биш. Хоол тухайн мөчид богино тайвшрал өгдөг тул тархи хамгийн хурдан ажилладаг аргаа дахин сонгодог байж болно.", ["стресс өндөр үед зөвхөн тэвчээрээр барих", "тайвшрах өөр гарцгүй байхад бүх зуушаа хорих"], "Идэхээс өмнө 3 минутын тайвшруулах завсарлага тавиад дараа нь идэх эсэхээ сонго.");
  }
  if (wp78HasAny("S1-F01", ["Өөрийгөө урамшуулмаар санагдсан", "Амттай зүйл идмээр санагдсан", "Уйдсан"], answers) || primaryKey === "reward" || primaryKey === "rewardDeficit") {
    addCluster("reward", "Таатай мэдрэмжийн дутагдлыг хоолоор нөхөх", "амттай зүйл, өөрийгөө урамшуулах хэрэгцээ, уйдалт эсвэл өдөржин өөртөө зай гаргаагүй байдал хамт харагдаж байна.", "Хэрвээ өдөрт хоолноос өөр амархан баярлуулах зүйл бага байвал хоол хамгийн хурдан reward болж үлддэг. Тиймээс зөвхөн амттанаа хорих нь гол хэрэгцээг шийдэхгүй.", ["бүх таатай зүйлээ хорих", "хоолноос өөр амралт төлөвлөхгүй байх"], "Өдөр бүр хоолноос өөр 10 минутын жижиг reward-г урьдчилж товло.");
  }
  if (wp78HasAny("MC-03", ["Сарын тэмдэг ирэхээс хэд хоногийн өмнө"], answers) || wp78HasAny("S1-R02", ["Сарын тэмдэг ирэхийн өмнөх өдрүүдэд"], answers) || wp78HasAny("S1-F01", ["Сарын тэмдгийн мөчлөгтэй холбоотой мэт санагдсан"], answers)) {
    addCluster("cycle", "Сарын тэмдэг ирэхийн өмнөх хэдэн өдөр", "Сарын тэмдэг ирэхийн өмнөх хэдэн өдөрт амттай юм хүсэх, ядаргаа эсвэл сэтгэл савлах мэдрэмж нэмэгдэж байж магадгүй.", "Энэ нь онош биш. Тэр өдрүүдэд өөрийгөө илүү чанга барихын оронд тогтмол хоол, зөөлөн бэлэн сонголт, өөрийгөө буруутгахгүй тэмдэглэл хэрэгтэй байж болно.", ["тэр өдрүүдэд хэт хатуу дүрэм эхлүүлэх", "өлсөлт, амттай зүйл хүсэх мэдрэмжийг зөвхөн сахилга бат гэж тайлбарлах"], "Тэр өдрүүдэд тогтмол хоол, нэг жижиг амттай сонголт, амрах 10 минут бэлд.");
  }
  if (wp78HasAny("S1-F01", ["Харагдаад эсвэл үнэртээд идмээр болсон"], answers) || primaryKey === "cue") {
    addCluster("cue", "Орчны дохио шийдвэрээс өмнө ажиллах", "Хоол харагдах, үнэртэх, ойр байх эсвэл захиалгын апп нээгдэхэд сонголт бараг автоматаар эхлэх магадлалтай.", "Зууш нүдэнд ойр байхаар гар өөрөө хүрчихдэг үе байна. Энэ үед асуудал ухамсар муудаж байгаа биш. Орчин таны өмнөөс эхний алхмыг хийгээд, гар амархан хүрдэг ойр байгаа сонголтыг хөнгөвчилж байна.", ["хоол харагдах орчинд зөвхөн willpower шаардах", "хүсээгүй сонголтыг хамгийн ойр байлгах"], "Нүдэнд хамгийн ойр байгаа нэг зүйлийг нэг алхам холдуулж, хүсэж буй сонголтоо харагдах газар тавь.");
  }
  if (wp78HasAny("S1-N01", ["4 цагаас бага", "4-6 цаг", "Чанар муу", "Тогтворгүй"], answers) || wp78HasAny("S1-N02", ["Ихэвчлэн", "Маш тод"], answers) || primaryKey === "circadian") {
    addCluster("circadian", "Нойр, тэнхээ, хоолны хэмнэлийн зөрүү", "Нойр, өдрийн сүүлийн кофе, өглөөний хоолгүй хэмнэл, оройн тэнхээний уналт идэх хүсэл болон бэлэн сонголттой давхцаж байна.", "Асуудал амттай юм хүссэндээ биш байж магадгүй. Гол нь нойр, тэнхээ, хоолны хэмнэлийн зөрүү, кофе уух цаг, өдрийн эхний хоол, оройн сулрал хамт нөлөөлж байна.", ["нойр муу өдөр хатуу хоолны дэглэм эхлүүлэх", "орой кофе уух", "өглөө/өдөр хоол алгасаад орой тэсэх"], "Өдрийн эхний хоолоо тогтмол болго. Өдрийн сүүлийн кофегоо хэзээ уухаа тогтоо. Орой 10 минут тайвшрах хугацаа гарга.");
  }
  if (wp78HasText(["шөнийн ээлж", "ээлжийн дараа", "цайны газар", "ойр дэлгүүр"], answers)) {
  ...
  const movement = wp78AnswerText("S1-MV01", answers);
  const movementBarrier = wp78AnswerText("S1-MV02", answers);
  const secondaryFactors = [
    alcoholUse ? "согтууруулах ундаа" : "",
    wp78HasAny("S1-T01", ["Өмнө татдаг байсан, одоо больсон", "Хааяа татдаг", "Өдөр бүр татдаг"], answers) ? "тамхи" : "",
    wp78HasText(["кофе"], answers) ? "кофе" : "",
    wp78HasAny("S1-E02", ["Стресс", "Санаа зовнил", "Уур", "Гуниг"], answers) ? "стресс" : "",
    wp78HasAny("S1-N01", ["4 цагаас бага", "4-6 цаг", "Чанар муу", "Тогтворгүй"], answers) ? "нойр" : "",
    wp78HasAny("S1-F01", ["Ядарсан"], answers) ? "ядаргаа" : "",
    wp78HasAny("S1-M02", ["3-4", "Бараг өдөр бүр"], answers) ? "хоол хоорондын зай" : "",
    movement ? `хөдөлгөөний бодит боломж: ${movement}` : "",
    movementBarrier ? `хөдөлгөөний саад: ${movementBarrier}` : "",
    hasMenstrualCycleContext(answers) ? "сарын тэмдгийн мөчлөг" : "",
    wp78HasAny("S1-F01", ["Татгалзах эвгүй байсан"], answers) ? "social pressure" : "",
    wp78HasAny("S1-B01", ["Гар салгалах", "Зүрх дэлсэх", "Хөлрөх", "Толгой эргэх", "Толгой өвдөх", "Сахар унасан мэт"], answers) ? "body signals" : ""
  ].filter(Boolean);
  if (!clusters.length && primaryKey) {
    addCluster("primary", publicMechanismShort(primaryKey), reportEvidenceNote(reportVoiceFor(primaryKey, tags).key), livedExplanationFor(primaryKey), avoidListFor(primaryKey, tags).slice(0, 3), leveragePoint(primaryKey, tags).copy || reportVoiceFor(primaryKey, tags).firstStep);
  }
  const receipts = wp78EvidenceReceipts({ clusters, secondaryFactors }, answers);
  ...
  return `
    ...
    <section class="screen">
      <div class="panel" data-report-output>
        ...
        <div class="report-section">
          <h3>Хамгийн хялбар эхлэх цэг</h3>
      ...
      <section class="screen">
        <div class="panel" data-report-output>
          <div class="report-section">
            ...
            <p class="muted">Энд эхлээд хоолны дүрэм биш, биеийн талаа шалгах нь зөв байна. Доорх богино нэгтгэлийг мэргэжлийн хүнтэй ярилцахдаа авч очиж болно.</p>
          </div>
          <div class="report-section">
