...
const ROUTES = Object.freeze({
  ...
  "/assessment/questions": "questions", "/assessment/result": "assessmentResult", "/assessment/completed": "assessmentCompleted",
  "/assessment/payment": "payment", "/report": "report", "/recovery": "recovery"
...
function scientificMethodologyBox() {
  return `<section class="scientific-methods-box" aria-labelledby="scientific-methods-title">
    ...
    <p class="scientific-methods-intro">Энэхүү тест үнэлгээний бүтэц, хэмжээс болон үр дүнгийн тайлбарыг боловсруулахдаа идэх зан үйл, сэтгэлзүйн хүчин зүйлсийг судалдаг олон улсын аргачлал, онолын хүрээг харгалзан үзсэн.</p>
    ...
    <div id="scientific-methods-details" class="scientific-methods-details">
      ...
      <p class="scientific-methods-disclaimer"><strong>Анхаарах нь:</strong> Энэхүү тест үнэлгээ нь дээрх асуумжуудын шууд орчуулга биш бөгөөд сэтгэлзүйн болон эмнэлзүйн онош тавихгүй. Эдгээр аргачлалд судлагддаг ойлголтуудыг ашиглан жин хасахад саад болж болзошгүй сэтгэлзүйн болон идэх зан үйлийн хэв маягийг танихад тусална.</p>
    </div>
  </section>`;
}
...
function renderLanding() {
  return `<div class="page landing-page">${navigation()}<main><section class="hero" aria-labelledby="page-title"><div class="hero-copy">
    ...
    <p class="hero-test-intro">Бүрэн тайлан тань яг үүнийг харуулна.</p>
    ...
    <section id="sample-report" class="sample-report" aria-labelledby="sample-title">
      ...
      <p class="report-preview-lead">Таны өгсөн хариултуудыг нэгтгэж, жин хасахад тань юу хамгийн их саад болж байгааг, тэр нь өдөр тутмын амьдралд тань хэрхэн илэрдгийг, юунаас эхэлбэл илүү бодитойг тайлбарлана.</p>
      <div class="sample-report-card">
        <div class="report-preview-item"><p class="sample-kicker">ТАНД ХАМГИЙН ИХ СААД БОЛЖ БУЙ ЗҮЙЛ</p><p>Сэтгэл хөдлөл, хэт хатуу дэглэм, ядаргаа, орчны нөлөө, цагийн хуваарь зэрэг хүчин зүйлээс аль нь таны жин хасах оролдлогод хамгийн их нөлөөлж байгааг тодорхойлно.</p></div>
        <div class="report-preview-item"><p class="sample-kicker">ЭНЭ НЬ ӨДӨР ТУТМЫН АМЬДРАЛД ХЭРХЭН ИЛЭРДЭГ ВЭ?</p><p>Та ямар үед хоолны хяналтаа алдах хандлагатай байдаг, ямар нөхцөлд дэглэмээ барихад хэцүү болдог, өмнөх оролдлогууд яагаад тогтвортой үргэлжлээгүйг таны хариулттай холбон тайлбарлана.</p></div>
        <div class="report-preview-item"><p class="sample-kicker">ЮУНААС ЭХЭЛЭХ ВЭ?</p><p>Бүхнийг зэрэг өөрчлөхийг шаардахгүй. Танд хамгийн түрүүнд анхаарах шаардлагатай, өдөр тутамдаа хэрэгжүүлж болох цөөн алхмыг санал болгоно.</p></div>
    ...
    <section class="methodology-summary" aria-labelledby="methodology-title">
      ...
      <div class="methodology-pillars">
        <article><h3>Аюулгүй байдлын дохио</h3><p>Хооллолтын эмгэг, хяналт алдах зан үйл, сэтгэл зүйн өндөр ачаалал болон нойрны эрсдэлтэй холбоотой анхаарах шинжийг үндсэн тестийн явцад танина.</p></article>
    ...
    ${scientificMethodologyBox()}</main>${footer()}</div>`;
}
function renderAbout() {
  return `<div class="page">${navigation()}<main class="content-card"><h1 id="page-title" tabindex="-1">Тест үнэлгээний тухай</h1>
    <p>Тестийг үнэ төлбөргүй бөглөнө. Таны хариултад тулгуурласан хувийн хэв маяг, илрэх нөхцөл, жин хасалтад саад болдог шалтгаан болон удирдах алхмууд бүрэн тайланд багтаж, нэг удаагийн төлбөр баталгаажсаны дараа нээгдэнэ.</p>
...
function renderAssessmentStart() {
  return `<div class="page">${navigation()}<main class="content-card assessment-start"><h1 id="page-title" tabindex="-1">Тестээ эхлүүлэх</h1>
    <p>Зөв, буруу хариулт байхгүй. Өөрт хамгийн ойр санагдсан хариултаа сонгоорой.</p>
    <p class="muted">Таны хариултаас шалтгаалан зарим асуулт нэмэгдэж болно.</p>
    <form id="assessment-start-form">
      ...
      <p id="start-error" class="error" role="alert" aria-live="assertive">${escapeHtml(state.invitationError || state.validationError)}</p>
      <button class="button" type="submit" ${state.busy ? "disabled" : ""}>${state.busy ? "Эхлүүлж байна…" : "Эхлэх"}</button>
...
function renderPayment() {
  ...
  return `<div class="page">${navigation()}<main class="content-card"><h1 id="page-title" tabindex="-1">${prepaid ? "Төлбөрөө баталгаажуулж байна" : "Бүрэн тайлангаа нээх"}</h1>
      <p>${prepaid ? "Тест үнэлгээ болон бүрэн хувийн тайлан" : `QPay-аар ${PRODUCT.displayPrice} төлсний дараа таны бүрэн тайлан нээгдэнэ.`}</p>
...
function renderReport() {
  ...
  if (!report.fullReport) return `<div class="page"><main class="content-card"><h1 id="page-title" tabindex="-1">Тайлангийн эрх баталгаажаагүй байна</h1><p>Бүрэн тайлан нээх эрх серверээс баталгаажаагүй байна.</p></main>${footer()}</div>`;
...
function hasAnalyticsData(summary) { return summary && ["eligibleVisitors", "uniqueVisitors", "assessmentsStarted", "assessmentsCompleted", "initialResultsViewed", "emailsSaved", "fullReportCtaClicks", "invoicesCreated", "paymentsConfirmed"].some(key => Number(summary[key] || 0) > 0); }
...
function analyticsCoverageCopy(coverage) {
  ...
  if (coverage?.freeFlowCutoverAt) {
    const [date, time] = formatAnalyticsDateTime(coverage.freeFlowCutoverAt).split(" ");
    notices.push(`Үнэгүй тестийн урсгал ${date}-ны ${time} цагаас эхэлсэн. Шинэ урсгалын зочны бүлгийг энэ мөчөөс тусад нь тооцно.`);
  } else if (coverage?.paidFirstCutoverAt) {
...
function analyticsFlowStateCopy(coverage) {
  const flowState = coverage?.flowState || "empty";
  if (flowState === "mixed") return "Сонгосон хугацаанд үнэгүй тестийн болон өмнөх төлбөрийн урсгалын бүртгэл хоёулаа байна. Урсгалуудын numerator, denominator-ийг хольж хувь тооцоогүй.";
  if (flowState === "historical_only") return "Сонгосон хугацаанд зөвхөн өмнөх төлбөрийн урсгалын бүртгэл байна. Үнэгүй тестийн хөрвөлтийн хувь хараахан үүсээгүй.";
  if (flowState === "legacy_with_prepaid_visitors") return "Сонгосон хугацаанд төлбөр-эхэнд урсгалын шинэ зочид бүртгэгдсэн боловч дараагийн шатны бүртгэл хараахан үүсээгүй.";
  if (flowState === "legacy_only") return "Сонгосон хугацааны бүртгэл өмнөх төлбөрийн урсгалд хамаарна.";
...
function renderAdminAnalytics() {
  ...
  const prepaid = analytics.prepaidFlow || {}; const legacy = analytics.legacyFlow || {}; const conversions = analytics.conversions || {}; const priorAvailable = hasAnalyticsData(analytics.priorCurrentFlow);
  const coverage = analytics.coverage || {}; const coverageNotices = analyticsCoverageCopy(coverage); const flowNotice = analyticsFlowStateCopy(coverage);
  ...
  const stages = [
    ...
    ["Бүрэн тайлан нээсэн", total.reportsOpened || 0, null],
...
function renderPrivacy() { return legalPage("Нууцлалын бодлого", `<p>Үйлчилгээ үзүүлэгч: Customer Business Development LLC-ийн ажиллуулдаг Jingeehas. Үйлчилгээ Монгол Улсын харьяалалд үйл ажиллагаа явуулна.</p><p>Тестийг төлбөрөөс өмнө бөглөж болно. Таны хариулт сесстэй холбогдон серверт хадгалагдаж, төлбөрөөр нээгдэх хувийн бүрэн тайланг гаргахад ашиглагдана.</p><p>Имэйл хаяг өгөх нь сонголттой. Хадгалсан имэйлийг тестийн үр дүн болон төлбөрөөр нээгдсэн бүрэн тайлангаа өөр төхөөрөмжөөс сэргээхэд ашиглана. Холбоо барих мэдээллийг шифрлэж, хайлтын утгыг тусад нь хэшлэнэ.</p><p>Түүхий хариултыг QPay нэхэмжлэлийн тайлбар, төлбөрийн мэдээлэл эсвэл ерөнхий хэрэглээний хэмжилтэд дамжуулахгүй. Тест дууссаны дараа тайлан бэлэн болсон дэлгэц харагдах боловч хувийн хэв маяг, илрэх нөхцөл, тайлбар болон зөвлөмж бүхий бүрэн тайлан зөвхөн төлбөр серверээр баталгаажсаны дараа нээгдэнэ. Зөвлөх зөвхөн таны тодорхой зөвшөөрөлтэй бүрэн тайланг харж болох бөгөөд асуулт бүрийн түүхий хариултыг харахгүй.</p><p>Хэрэглэгч зөвшөөрлөө цуцалж, хууль болон төлбөрийн бүртгэлээр заавал хадгалах мэдээллээс бусдыг устгуулах хүсэлт гаргаж болно. Баталгаажсан устгах хүсэлтийг 30 хоногийн дотор шийдвэрлэнэ.</p><p>Үйлчилгээний үндсэн үе шатны ашиглалтыг сайжруулахын тулд нэр, холбоо барих мэдээлэл, тестийн хариулт агуулаагүй нууцлагдсан зочин, сесс болон урсгалын танигчаар өдрийн нийлбэр үзүүлэлт хэмжинэ. Төхөөрөмжийн хурууны хээ үүсгэхгүй бөгөөд түүхий IP хаяг хадгалахгүй.</p><p>Нууцлалын хүсэлт: ${supportContactLink()}.</p>`); }
function renderTerms() { return legalPage("Үйлчилгээний нөхцөл", `<p>Үйлчилгээ үзүүлэгч: Customer Business Development LLC-ийн ажиллуулдаг Jingeehas. Үйлчилгээ Монгол Улсын харьяалалд үйл ажиллагаа явуулна.</p><p>Энэ тест үнэлгээ нь насанд хүрсэн хэрэглэгчийн өөрийн хариултад тулгуурласан ажиглалт гаргана. Эмнэлгийн онош тавихгүй бөгөөд эмч, сэтгэлзүйч, хоолзүйчийн зөвлөгөө, эмчилгээ, яаралтай тусламжийг орлохгүй. Жин хасах үр дүнг баталгаажуулахгүй.</p><p>Тестийг үнэ төлбөргүй бөглөнө. ${PRODUCT.displayPrice} нь хувийн хэв маяг, илрэх нөхцөл, жин хасалтад саад болдог шалтгаан болон удирдах алхмууд бүхий бүрэн тайланг нээх нэг удаагийн төлбөр бөгөөд тайлан зөвхөн төлбөрийн үйлчилгээ үзүүлэгчийн баталгааг сервер шалгасны дараа нээгдэнэ. Аюулгүй байдлын зөвлөмж төлбөргүй.</p><p>Давхар төлбөр, баталгаатай системийн алдаа, эсвэл төлбөр төлсөн боловч бүрэн тайланг техникийн шалтгаанаар өгөөгүй бөгөөд дэмжлэгээр шийдвэрлэж чадаагүй тохиолдлыг шалгаж, буцаан олголтын хүсэлтийг хянан шийдвэрлэнэ.</p><p>Нөхцөлтэй холбоотой хүсэлт: ${supportContactLink()}.</p>`); }
...
function renderForPath(pathname) {
  ...
  if (route === "assessmentResult") return renderInitialResult();
  if (route === "assessmentCompleted") return renderAssessmentCompleted();
  if (route === "payment") return renderPayment();
  if (route === "questions") return state.questionsAuthorized ? renderQuestions() : `<div class="page">${navigation()}<main class="content-card"><h1 id="page-title" tabindex="-1">Тестийг нээж байна</h1><p role="status">Тестийн явцыг серверээс баталгаажуулж байна…</p></main>${footer()}</div>`;
...
function applyAssessmentState(restored) {
  if (!restored?.assessment) return;
  state.assessmentId = restored.assessment.assessmentId;
...
async function authorizeAssessmentQuestions(analyticsContext = {}) {
  const access = await api("/.netlify/functions/weight-assessment-questions", {
    method: "POST",
    body: JSON.stringify({ assessmentId: state.assessmentId, analyticsContext })
  });
  state.assessmentStatus = access.status;
...
async function continueToPayment() {
  ...
  try {
    state.payment = await api("/.netlify/functions/qpay-create-invoice", {
      method: "POST",
      body: JSON.stringify({ assessmentId: state.assessmentId, productCode: PRODUCT.code, amount: PRODUCT.amount })
    });
  } catch (error) {
    const ambiguous = ["invoice_create_unknown", "invoice_reconciliation_required", "replacement_authorization_required"].includes(error?.body?.error);
    setPaymentStatus(ambiguous ? "create_unknown" : "create_error");
