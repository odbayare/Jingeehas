...
function ordinaryReportOpeningTitle(primaryKey, tags = []) {
  ...
  if (primaryKey === "reward" || primaryKey === "rewardDeficit" || tags.includes("reward_pull")) {
    return "Орой амттай зүйл “миний юм” шиг санагдаж байна";
  }
...
const REPORT_VOICE_LIBRARY = {
  ...
  rewardDeficit: {
    ...
    needs: ["Өөртөө өгөх жижиг таатай мөч", "Өдөржин хойш тавигдсан өөрийгөө санах", "“Миний цаг” гэсэн мэдрэмж авах"],
    cycle: [
      ...
      "Амттай зүйл “миний юм” шиг санагдана",
    ...
    needs: [
      ...
      "Тухайн өдрийн биеэ зөөлөн сонсох"
    ],
    cycle: [
  ...
  circadian: {
    opening: [
      ...
      "Тиймээс эхлэл нь зөвхөн хоол хорих биш. Кофеины хил, орой унтраах 10 минуттай хамт явна."
    ],
    ...
    notProblem: "Асуудал амттай юм хүссэндээ биш байж магадгүй. Нойр, кофеин, өдрийн эхний хоол, оройн сулрал хамт нөлөөлж байна.",
    ...
    experiment: [
      ...
      ["4-10 дахь өдөр", "үдээс хойш кофеин уух хил тавьж, орой унтраах 10 минут турш."],
  ...
  const summaries = {
    ...
    circadian: {
      ...
      meaningBullets: [
        ...
        "Нойр, кофеин, өглөөний хоолгүй эхлэх зэрэг нь оройн хүсэлтэй хамт явж байна."
      ],
      firstStep: "Өдрийн эхний хоол, кофеиний хил, орой унтраах 10 минут турш.",
